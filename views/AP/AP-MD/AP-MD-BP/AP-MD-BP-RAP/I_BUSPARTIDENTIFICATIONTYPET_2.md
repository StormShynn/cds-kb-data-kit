...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_BUSPARTIDENTIFICATIONTYPET_2')/$value) |
...
| `BPIdentificationTypeName` |  | |  |  | `CHAR(40)` | Description |
