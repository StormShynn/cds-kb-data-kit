...
| Field | Data Source |
|---|---|
| key `UserID` | `I_ProcmtUserDefaultCatalogs.Employee` |
| key `PersonalizationID` | `I_ProcmtUserDefaultCatalogs.PersonalizationID` |
| key `BusinessObjectType` | `I_ProcmtUserDefaultCatalogs.BusinessObjectType` |
| key `ProcmtCatalogID` | `I_ProcmtUserDefaultCatalogs.PurReqnSSPCatalog` |
