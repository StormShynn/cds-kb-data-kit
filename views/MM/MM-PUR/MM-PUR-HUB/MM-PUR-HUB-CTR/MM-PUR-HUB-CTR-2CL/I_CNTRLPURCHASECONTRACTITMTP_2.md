...
| `_CentralPurchaseContItemDist` | *Association* |
| `_CentrlPurContrItmCndnValdty` | *Association* |
| `_CntrlPurContrItmNotes` | *Association* |
| `_CntrlPurContrItmCmmdtyQty` | *Association* |
