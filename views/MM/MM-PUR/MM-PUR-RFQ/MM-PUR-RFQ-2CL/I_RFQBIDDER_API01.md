...
| Field | Data Source |
|---|---|
| key `RequestForQuotation` | `I_RFQBidder.RequestForQuotation` |
| key `PartnerCounter` | `I_RFQBidder.PartnerCounter` |
| key `PartnerFunction` | `cast( I_RFQBidder.PartnerFunction as parvw )` |
