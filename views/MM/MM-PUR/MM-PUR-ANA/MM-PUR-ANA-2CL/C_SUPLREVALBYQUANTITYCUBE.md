...
| Field | Data Source |
|---|---|
| key `PurchaseOrder` | `cast( QuantityVariance.PurchaseOrder as vdm_purchaseorder )` |
| key `PurchaseOrderItem` | `cast( QuantityVariance.PurchaseOrderItem as vdm_purchaseorderitem)` |
