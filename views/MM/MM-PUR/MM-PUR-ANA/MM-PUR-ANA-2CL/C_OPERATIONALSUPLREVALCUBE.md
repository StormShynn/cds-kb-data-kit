...
| Field | Data Source |
|---|---|
| key `PurchasingDocument` | `cast( PurchaseOrder as mm_a_purchasing_document preserving type )` |
| key `PurchasingDocumentItem` | `cast( PurchaseOrderItem as mm_a_purchasing_document_item preserving type )` |
