...
| `_PurchaseOrderItemNote` | *Association* |
| `_PurOrdAccountAssignment` | *Association* |
| `_PurOrdPricingElement` | *Association* |
| `_PurchaseOrderScheduleLineTP` | *Association* |
| `_PurchaseOrderInvoicingPlan` | *Association* |
