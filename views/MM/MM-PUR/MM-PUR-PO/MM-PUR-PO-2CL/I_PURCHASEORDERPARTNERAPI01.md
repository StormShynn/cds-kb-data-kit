...
| Field | Data Source |
|---|---|
| key `PurchaseOrder` | `partner.PurchaseOrder` |
| key `PurchasingOrganization` | `partner.PurchasingOrganization` |
| key `SupplierSubrange` | `SupplierSubrange` |
| key `Plant` | `Plant` |
| key `PartnerFunction` | `cast ( PartnerFunction as parvw preserving type )` |
