...
| Field | Data Source |
|---|---|
| key `simpleType` | `cast( enum.simpleType as abap.char(30) )` |
| key `enumIdentifier` | `cast( enum.enumIdentifier as abap.char(30) )` |
| key `enumValue` | `cast( enum.enumValue as abap.numc(3) )` |
| `_Text` | *Association* |
