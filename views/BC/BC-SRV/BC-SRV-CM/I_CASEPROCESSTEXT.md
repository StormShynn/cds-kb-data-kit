...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CASEPROCESSTEXT')/$value) |
...
| `CaseProcessName` |  | |  |  | `CHAR(40)` | Case: Process Short Text |
