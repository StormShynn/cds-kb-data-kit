...
| Field | Data Source |
|---|---|
| key `OrderInternalID` | `cast(afvg.OrderInternalID as pph_aufpl preserving type)` |
...
| `OperationHasLongText` | `cast(case afvg.Language when '' then '' else 'X' end as aufltext preserving type)` |
