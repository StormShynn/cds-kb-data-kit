...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENGMNTPRJMARGOVWDST')/$value) |
...
| `hno_00014` |  | |  |  | `CHAR(32)` |  |
| `hio_00014` |  | |  |  | `CHAR(30)` |  |
| `tra_00015` |  | |  |  | `INT4(10)` | Financial Planning Entry Item |
| `sva_00015` |  | |  |  | `CHAR(1)` |  |
| `tra_00016` |  | |  |  | `CHAR(2)` |  |
| `sva_00016` |  | |  |  | `CHAR(1)` |  |
| `tra_00017` |  | |  |  | `CHAR(10)` |  |
