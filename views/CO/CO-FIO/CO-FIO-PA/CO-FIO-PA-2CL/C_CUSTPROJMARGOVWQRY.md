...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CUSTPROJMARGOVWQRY')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CUSTPROJMARGOVWQRY')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CUSTPROJMARGOVWQRY')/$value)*
...
@EndUserText.label: 'Customer Project Margin Query'
@Analytics.intentBasedNavigation.filterMapper: 'CL_FINS_MA_PJBSDSRVC_RB_EXIT'
...
@OData.publish: true
define transient view entity C_CustProjMargOvwQry 
