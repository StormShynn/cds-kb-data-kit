...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENTPRJMARGINITEMDST')/$value) |
...
| `TRA_00032` |  | |  |  | `INT4(10)` | Financial Planning Entry Item |
| `sva_00032` |  | |  |  | `CHAR(1)` |  |
| `tra_00033` |  | |  |  | `CHAR(10)` |  |
| `sva_00033` |  | |  |  | `CHAR(1)` |  |
