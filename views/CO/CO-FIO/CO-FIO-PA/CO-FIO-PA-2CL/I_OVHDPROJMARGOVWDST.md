...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_OVHDPROJMARGOVWDST')/$value) |
...
| `tra_00011` |  | |  |  | `CHAR(4)` |  |
| `sva_00011` |  | |  |  | `CHAR(1)` |  |
| `TRA_00012` |  | |  |  | `INT4(10)` | Financial Planning Entry Item |
| `sva_00012` |  | |  |  | `CHAR(1)` |  |
| `tra_00013` |  | |  |  | `CHAR(4)` |  |
| `sva_00013` |  | |  |  | `CHAR(1)` |  |
| `tra_00014` |  | |  |  | `CHAR(2)` |  |
