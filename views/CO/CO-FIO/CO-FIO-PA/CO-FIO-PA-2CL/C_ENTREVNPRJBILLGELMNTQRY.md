...
description: Enterprise Project Billing Element Query
...
semantic_en: Enterprise Project Billing Element Query
tags:
  - CO
  - billing
  - bo:billingdocument
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_ENTREVNPRJBILLGELMNTQRY')/$value) |
...
| `DownPaymentAmountInDspCrcy` | `DEC(23)` |  |
