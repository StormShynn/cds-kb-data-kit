...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_REVNPRJMARGOVWQRY')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_REVNPRJMARGOVWQRY')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_REVNPRJMARGOVWQRY')/$value)*
...
@EndUserText.label: 'Project with Revn Margin Overview Query'
@Analytics.intentBasedNavigation.filterMapper: 'CL_FINS_MA_RVNPRJMARG_RB_EXIT'
...
define transient view entity C_RevnPrjMargOvwQry
