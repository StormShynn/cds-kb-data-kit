...
description: Revenue Prj with Billing Element Query
...
semantic_en: Revenue Prj with Billing Element Query
tags:
  - CO
  - billing
  - bo:billingdocument
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_REVNPRJBILLGELMNTQRY')/$value) |
