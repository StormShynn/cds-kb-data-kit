...
| Field | Data Source |
|---|---|
| key `ServiceDocumentType` | `_AcctgServiceDocument.ServiceDocumentType` |
| key `ServiceDocument` | `_AcctgServiceDocument.ServiceDocument` |
| key `ServiceDocumentItem` | `_AcctgServiceDocument.ServiceDocumentItem` |
