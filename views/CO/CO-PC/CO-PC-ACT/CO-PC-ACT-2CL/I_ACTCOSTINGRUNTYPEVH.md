...
| Field | Data Source |
|---|---|
| key `CostingRunType` | `CostingRunType` |
| key `FiscalYear` | `cast( FiscalYear as fis_gjahr_no_conv preserving type )` |
| key `FiscalPeriod` | `cast( FiscalPeriod as fins_fiscalperiod preserving type )` |
