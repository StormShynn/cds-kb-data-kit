...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_LOSSALLOWANCELAYOUTTEXT')/$value) |
...
| `LossAllowanceLayoutName` |  | |  |  | `CHAR(70)` | Name of Key Figure Layout |
