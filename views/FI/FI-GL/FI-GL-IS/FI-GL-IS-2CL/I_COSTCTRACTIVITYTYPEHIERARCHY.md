...
| Field | Data Source |
|---|---|
| key `ControllingArea` | `cast( hrrp_dir_n.kokrs as fis_kokrs preserving type )` |
| key `CostCtrActivityTypeHierarchy` | `cast(hrrp_dir_n.hryid as fis_hryid_cctracttytpe preserving type )` |
