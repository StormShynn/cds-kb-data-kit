...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_TRIALBALANCE')/$value) |
...
| `GLAccountHierarchy` |  | |  |  | `CHAR(10)` | Account Number |
| `GLAccountHierarchyName` |  | |  |  | `CHAR(20)` | G/L Account Name |
...
| `SenderCostCenterName` |  | |  |  | `CHAR(20)` | Partner Cost Center Name |
| `PartnerProfitCenter` |  | |  |  | `CHAR(10)` | Partner Profit Center |
| `PartnerProfitCenterName` |  | |  |  | `CHAR(20)` | Partner Profit Center Name |
| `PartnerFunctionalArea` |  | |  |  | `CHAR(16)` | Partner Functional Area |
| `PartnerFunctionalAreaName` |  | |  |  | `CHAR(25)` | Name of the Partner Functional Area |
...
| `EliminationProfitCenterName` |  | |  |  | `CHAR(20)` | Elimination Profit Center Name |
...
| `InvtrySpecialStockSupplierName` |  | |  |  | `CHAR(80)` | Inventory Special Stock Supplier Name |
...
| `StrtgBalAmtInFreeDfndCrcy1` |  | |  |  | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 1 |
| `DebitAmountInFreeDfndCrcy1` |  | |  |  | `CURR(23)` | Debit Balance in Freely Defined Currency 1 |
| `CreditAmountInFreeDfndCrcy1` |  | |  |  | `CURR(23)` | Credit Balance in Freely Defined Currency 1 |
...
| `StrtgBalAmtInFreeDfndCrcy2` |  | |  |  | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 2 |
| `DebitAmountInFreeDfndCrcy2` |  | |  |  | `CURR(23)` | Debit Balance in Freely Defined Currency 2 |
| `CreditAmountInFreeDfndCrcy2` |  | |  |  | `CURR(23)` | Credit Balance in Freely Defined Currency 2 |
...
| `StrtgBalAmtInFreeDfndCrcy3` |  | |  |  | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 3 |
| `DebitAmountInFreeDfndCrcy3` |  | |  |  | `CURR(23)` | Debit Balance in Freely Defined Currency 3 |
| `CreditAmountInFreeDfndCrcy3` |  | |  |  | `CURR(23)` | Credit Balance in Freely Defined Currency 3 |
...
| `StrtgBalAmtInFreeDfndCrcy4` |  | |  |  | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 4 |
| `DebitAmountInFreeDfndCrcy4` |  | |  |  | `CURR(23)` | Debit Balance in Freely Defined Currency 4 |
| `CreditAmountInFreeDfndCrcy4` |  | |  |  | `CURR(23)` | Credit Balance in Freely Defined Currency 4 |
...
| `StrtgBalAmtInFreeDfndCrcy5` |  | |  |  | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 5 |
| `DebitAmountInFreeDfndCrcy5` |  | |  |  | `CURR(23)` | Debit Balance in Freely Defined Currency 5 |
| `CreditAmountInFreeDfndCrcy5` |  | |  |  | `CURR(23)` | Credit Balance in Freely Defined Currency 5 |
...
| `StrtgBalAmtInFreeDfndCrcy6` |  | |  |  | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 6 |
| `DebitAmountInFreeDfndCrcy6` |  | |  |  | `CURR(23)` | Debit Balance in Freely Defined Currency 6 |
| `CreditAmountInFreeDfndCrcy6` |  | |  |  | `CURR(23)` | Credit Balance in Freely Defined Currency 6 |
...
| `StrtgBalAmtInFreeDfndCrcy7` |  | |  |  | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 7 |
| `DebitAmountInFreeDfndCrcy7` |  | |  |  | `CURR(23)` | Debit Balance in Freely Defined Currency 7 |
| `CreditAmountInFreeDfndCrcy7` |  | |  |  | `CURR(23)` | Credit Balance in Freely Defined Currency 7 |
...
| `StrtgBalAmtInFreeDfndCrcy8` |  | |  |  | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 8 |
| `DebitAmountInFreeDfndCrcy8` |  | |  |  | `CURR(23)` | Debit Balance in Freely Defined Currency 8 |
| `CreditAmountInFreeDfndCrcy8` |  | |  |  | `CURR(23)` | Credit Balance in Freely Defined Currency 8 |
