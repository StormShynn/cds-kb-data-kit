...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_INVESTMENTSUPPORTMEASURETEXT')/$value) |
...
| `InvestmentSupportMeasureName` |  | |  |  | `CHAR(50)` | Investment Support Measure |
