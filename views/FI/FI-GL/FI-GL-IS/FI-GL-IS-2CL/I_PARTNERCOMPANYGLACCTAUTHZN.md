...
| Field | Data Source |
|---|---|
| key `PartnerCompany` | `P_PartnerCompanyGLAcctAuthzn.PartnerCompany` |
| key `GLAccount` | `cast ( 'F_BKPF_BES' as fis_racct preserving type )` |
| key `AuthorizationGroup` | `P_PartnerCompanyGLAcctAuthzn.AuthorizationGroup` |
