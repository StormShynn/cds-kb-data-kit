...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CASHFLOWINDIRECTIFRS')/$value) |
...
| `GLAcctNetIncomeAmtInCCCrcy` | `CURR(23)` | Profit for the Period |
