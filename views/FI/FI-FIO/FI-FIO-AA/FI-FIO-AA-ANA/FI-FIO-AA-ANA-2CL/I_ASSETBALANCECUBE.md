...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ASSETBALANCECUBE')/$value) |
...
| `AcquisitionValueDate` |  | |  |  | `DATS(8)` | Asset Value Date of the First Posting |
