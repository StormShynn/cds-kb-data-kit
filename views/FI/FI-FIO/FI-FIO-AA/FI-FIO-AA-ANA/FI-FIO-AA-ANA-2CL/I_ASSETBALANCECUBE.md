...
semantic_vi: Asset Balances - Cube — CDS view giao diện dựa trên P_AssetBalanceCube1.
keywords:
  - Asset Balances - Cube
  - asset
  - balances
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ASSETBALANCECUBE')/$value) |
...
| `AcquisitionValueDate` |  | | `_FixedAssetForLedger` | `AcquisitionValueDate` | `DATS(8)` | Asset Value Date of the First Posting |
...
| `AssetAuthorizationContext` |  | | `_FixedAsset` | `AssetAuthorizationContext` | `CHAR(10)` | Asset Authorization Context |
...
| `_DocumentStore` | `I_AssetBalanceDSt` | [0..1] |

## Source Code

*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ASSETBALANCECUBE')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ASSETBALANCECUBE')/$value)*
