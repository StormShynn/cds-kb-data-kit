...
| Field | Data Source |
|---|---|
| key `RevnAcctgSenderComponent` | `cast(srcdoc_comp as farr_cds_rai_srcco preserving type)` |
| key `RASndgCompLogicalSystem` | `srcdoc_logsys` |
| key `RASndgCompDocumentItemType` | `srcdoc_type` |
| key `RASndgCompDocumentItem` | `srcdoc_id` |
