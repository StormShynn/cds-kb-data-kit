...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ASSETDEPRECIATIONTYPETEXT')/$value) |
...
| `DepreciationTypeName` |  | |  |  | `CHAR(60)` | Short Descriptive Text: Depreciation Type |
