...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ASSETKEYFIGURESETTEXT')/$value) |
...
| `AssetAcctgKeyFigureSetName` |  | |  |  | `CHAR(50)` | Text Field |
