...
| Field | Data Source |
|---|---|
| key `US_TaxPartnerTaxDocument` | `etxdcj.docnr` |
| key `US_TaxPartnerTaxDocumentItem` | `etxdcj.itemnr` |
| key `TaxJurisdictionLevel` | `cast(etxdcj.txjlv as txjcd_level preserving type)` |
