...
| Field | Data Source |
|---|---|
| key `CompanyCode` | `JournalEntryTypeMapping.bukrs` |
| key `CN_CADENatlStdRelVersion` | `JournalEntryTypeMapping.cade_natl_std_rel_ver` |
| key `AccountingDocumentType` | `JournalEntryTypeMapping.blart` |
