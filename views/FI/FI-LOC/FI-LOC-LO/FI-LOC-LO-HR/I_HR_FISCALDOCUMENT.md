...
| key `BusinessSpaceCode` | `bus_space_code` |
| key `ChargingDeviceCode` | `chg_dev_code` |
| key `FiscalDocument` | `fisc_document` |
| key `PostingFiscalYear` | `fiscal_year` |
| key `HR_FiscalDocumentType` | `appli` |
| `PostingDate` | `budat` |
