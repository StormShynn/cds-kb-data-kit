...
| Field | Data Source |
|---|---|
| key `BR_NotaFiscal` | `NFTax.docnum` |
| key `BR_NotaFiscalItem` | `NFTax.itmnum` |
| key `BR_TaxType` | `NFTax.taxtyp` |
| key `TaxGroup` | `cast(NFTax.taxgrp as logbr_taxgrp preserving type)` |
