...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ARAGINGGRIDGENLEDGERCUBE')/$value) |
...
| `CustomerFinsAuthorizationGrp` | `CHAR(4)` | Customer Financials Authorization Group |
