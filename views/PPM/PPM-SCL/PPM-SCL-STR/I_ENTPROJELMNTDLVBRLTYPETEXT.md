...
| Field | Data Source |
|---|---|
| key `Language` | `DlvTypeCode.Language` |
| key `EntProjElmntDeliverableType` | `cast ( substring( ResourceID.resource_id, 1, 6 ) as /s4ppm/tv_entprojdlvbrltype preserving type )` |
