...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SETTLMTPRECDGDOCCATTEXT')/$value) |
...
| `SettlmtPrecdgDocCatName` |  | |  |  | `CHAR(60)` | Description for Document Category of Preceding Document |
