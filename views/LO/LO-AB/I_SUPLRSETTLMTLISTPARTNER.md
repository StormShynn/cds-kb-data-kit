...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SUPLRSETTLMTLISTPARTNER')/$value) |
...
| `SettlmtMgmtPartAddrRefType` | `CHAR(1)` | Address indicator |
