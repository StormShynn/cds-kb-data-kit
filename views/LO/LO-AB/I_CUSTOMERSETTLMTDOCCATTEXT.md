...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CUSTOMERSETTLMTDOCCATTEXT')/$value) |
...
| `CustomerSettlmtDocCatName` |  | |  |  | `CHAR(60)` | Settlement Document Type - Customer Description |
