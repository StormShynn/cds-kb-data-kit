...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SETTLMTCATTEXT')/$value) |
...
| `SettlmtCatName` | `CHAR(60)` | Settlement Category Description |
