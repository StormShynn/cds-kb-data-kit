...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SETTLMTADDLREFDOCCATTEXT')/$value) |
...
| `SettlmtAddlRefDocCatName` |  | |  |  | `CHAR(60)` | Text of Additional Reference Document Category |
