...
| Field | Data Source |
|---|---|
| key `ProdUnivHierarchy` | `cast(substring( hryid, 6, 26 ) as prod_hier_id )` |
| key `ProdHierarchyValidityEndDate` | `cast(hryvalto as prodhierarchyvalidityenddate preserving type )` |
