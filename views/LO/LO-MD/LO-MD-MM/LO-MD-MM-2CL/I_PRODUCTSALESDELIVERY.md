...
| Field | Data Source |
|---|---|
| key `Product` | `cast (mvke.matnr as productnumber preserving type )` |
| key `ProductSalesOrg` | `mvke.vkorg` |
| key `ProductDistributionChnl` | `mvke.vtweg` |
