...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_BATCHWITHPLANT_2')/$value) |
...
| `BatchPlantIsMarkedForDeletion` | `CHAR(1)` | Deletion Indicator |
...
| `IsSubordinateBatch` | `CHAR(1)` | Subordinate Batch |
