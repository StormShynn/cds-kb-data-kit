...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CNDNCONTRPRTLSETTLMTCATTXT')/$value) |

## Fields

| Field | Key | Association | Via | Source | Type | Description |
|---|---|---|---|---|---|---|
| `CndnContrPrtlSettlmtCat` |  | |  |  | `CHAR(1)` | Condition Contract Settlement: Partial Settlement Type |
| `Language` |  | |  |  | `LANG(1)` | Language Key |
| `CndnContrPrtlSettlmtCatName` |  | |  |  | `CHAR(60)` | Short Text for Fixed Values |
