...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CNDNCONTRACCRRVSLCATTEXT')/$value) |

## Fields

| Field | Key | Association | Via | Source | Type | Description |
|---|---|---|---|---|---|---|
| `CndnContrAccrRvslCat` |  | |  |  | `CHAR(1)` | Accruals Reversal Type |
| `Language` |  | |  |  | `LANG(1)` | Language Key |
| `CndnContrAccrRvslCatName` |  | |  |  | `CHAR(60)` | Description of Accruals Reversal Type |
