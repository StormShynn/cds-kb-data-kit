...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_BUSVOLSELECTIONGROUPTEXT')/$value) |
...
| `BusVolFieldCombnTypeDesc` |  | |  |  | `CHAR(40)` | Description |
