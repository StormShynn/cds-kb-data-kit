...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CNCONSETLDETLDSTMNTSUPLRINVC')/$value) |
...
| `SettledSuplrInvc` |  | |  |  | `CHAR(10)` | Settled Supplier Invoice |
| `SettledSuplrInvcFiscalYear` |  | |  |  | `NUMC(4)` | Fiscal Year of a Supplier Invoice |
| `SettledSuplrInvcItem` |  | |  |  | `NUMC(6)` | Item of a Settled Supplier Invoice |
