...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_FASHIONPRODINFOFLD1TEXT')/$value) |
...
| `FashionProdInfoField1Text` | `CHAR(40)` | Fashion Information Field: Description for field 1 |
