...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CONSIGNMENTCONTROLTEXT')/$value) |
...
| `ConsignmentControlDescription` |  | |  |  | `CHAR(60)` | Name of Consignment Control |
