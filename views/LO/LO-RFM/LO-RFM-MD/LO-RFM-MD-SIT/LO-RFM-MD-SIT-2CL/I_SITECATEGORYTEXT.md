...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SITECATEGORYTEXT')/$value) |

## Fields

| Field | Key | Association | Via | Source | Type | Description |
|---|---|---|---|---|---|---|
| `SiteCategory` |  | |  |  | `CHAR(1)` | Processing status of the promotion |
| `Language` |  | |  |  | `LANG(1)` | Language Key |
| `SiteCategoryName` |  | |  |  | `CHAR(60)` | Site Category |
