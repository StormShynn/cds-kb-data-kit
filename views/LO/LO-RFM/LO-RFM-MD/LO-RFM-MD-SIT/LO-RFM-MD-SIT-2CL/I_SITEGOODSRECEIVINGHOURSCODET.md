...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SITEGOODSRECEIVINGHOURSCODET')/$value) |
...
| `SiteGoodsReceivingHoursText` |  | |  |  | `CHAR(30)` | Description |
