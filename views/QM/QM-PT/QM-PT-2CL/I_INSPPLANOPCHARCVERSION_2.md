...
| Field | Data Source |
|---|---|
| key `InspectionPlanGroup` | `_BOOCharacteristicVersion.BillOfOperationsGroup` |
| key `BOOOperationInternalID` | `_BOOCharacteristicVersion.BOOOperationInternalID` |
| key `BOOCharacteristic` | `_BOOCharacteristicVersion.BOOCharacteristic` |
| key `BOOCharacteristicVersion` | `_BOOCharacteristicVersion.BOOCharacteristicVersion` |
| key `InspectionPlan` | `_InspPlanOpAssgmt.InspectionPlan` |
| key `BillOfOperationsType` | `_BOOCharacteristicVersion.BillOfOperationsType` |
