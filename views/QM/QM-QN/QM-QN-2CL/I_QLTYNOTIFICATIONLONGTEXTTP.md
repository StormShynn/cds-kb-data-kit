...
| Field | Data Source |
|---|---|
| key `QualityNotification` | `_QltyNotificationLongText.QualityNotification` |
| key `LongTextInternalNumber` | `_QltyNotificationLongText.LongTextInternalNumber` |
| key `Language` | `_QltyNotificationLongText.Language` |
