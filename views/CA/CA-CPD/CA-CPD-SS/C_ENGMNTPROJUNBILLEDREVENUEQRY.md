...
description: This CDS view provides the prerequisites for answering the following business questions. Note that information is retrieved only from the leading ledger. What is the unbilled amount in projects that I manage? What is the unbilled amount per billing item type (fixed price, time and expense, and so on)?
