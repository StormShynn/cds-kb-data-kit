...
| Field | Data Source |
|---|---|
| key `CompanyCode` | `JVACtbckWBSMappgInterBsc.CompanyCode` |
| key `JntVntrIntcoCode` | `JVACtbckWBSMappgInterBsc.JntVntrIntcoCode` |
| key `JVAFromProject` | `JVACtbckWBSMappgInterBsc.JVAFromProject` |
