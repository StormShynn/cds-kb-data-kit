...
| key `ClassInternalID` | `ObjectClassBasic.ClassInternalID` |
| key `ClassType` | `ObjectClassBasic.ClassType` |
| key `TimeIntervalNumber` | `ObjectClassBasic.TimeIntervalNumber` |
