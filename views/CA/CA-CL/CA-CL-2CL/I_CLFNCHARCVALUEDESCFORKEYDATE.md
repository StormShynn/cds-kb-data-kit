...
| Field | Data Source |
|---|---|
| key `CharcInternalID` | `CharcValueDesc.CharcInternalID` |
| key `CharcValuePositionNumber` | `CharcValueDesc.CharcValuePositionNumber` |
| key `Language` | `CharcValueDesc.Language` |
