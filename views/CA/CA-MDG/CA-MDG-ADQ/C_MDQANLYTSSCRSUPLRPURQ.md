...
description: MDQ Score Supplier Purchase - Query
...
semantic_en: MDQ Score Supplier Purchase - Query
keywords:
...
**MDQ Score Supplier Purchase - Query**
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRSUPLRPURQ')/$value) |
