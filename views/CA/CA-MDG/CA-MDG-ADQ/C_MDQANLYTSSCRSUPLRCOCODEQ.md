...
description: MDQ Score Supplier Company Code - Query
...
semantic_en: MDQ Score Supplier Company Code - Query
keywords:
...
**MDQ Score Supplier Company Code - Query**
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRSUPLRCOCODEQ')/$value) |
