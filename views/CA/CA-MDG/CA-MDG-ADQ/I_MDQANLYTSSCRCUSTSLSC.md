...
description: MDQ Score for Customer Sales - Cube
...
semantic_en: MDQ Score for Customer Sales - Cube
keywords:
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MDQANLYTSSCRCUSTSLSC')/$value) |
