...
description: MDQ Score for Customer - Query
...
semantic_en: MDQ Score for Customer - Query
keywords:
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRCUSTQ')/$value) |
