...
| Field | Data Source |
|---|---|
| key `FiscalYearVariant` | `P_FiscalYearQuarter.FiscalYearVariant` |
| key `FiscalYear` | `P_FiscalYearQuarter.FiscalYear` |
| key `FiscalYearQuarter` | `P_FiscalYearQuarter.FiscalYearQuarter` |
