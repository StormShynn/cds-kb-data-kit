...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_EWM_STORAGEBINACTYAREAQ')/$value) |
...
| `EWMStorageBinRmngDepthPct` | `DEC(5)` | Storage Bin Remaining Bin Depth in Percent |
| `EWMStorageBinUsedDepthPct` | `DEC(5)` | Storage Bin Used Bin Depth in Percent |
