...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_EWM_WAREHOUSETASKQ_2')/$value) |
...
| `SourceStorageSectionName` | `CHAR(40)` | Description |
...
| `ExecutingResourceGroupName` | `CHAR(40)` | Description |
| `ExecutingResourceType` | `CHAR(4)` |  |
| `ExecutingResourceTypeName` | `CHAR(40)` | Description |
