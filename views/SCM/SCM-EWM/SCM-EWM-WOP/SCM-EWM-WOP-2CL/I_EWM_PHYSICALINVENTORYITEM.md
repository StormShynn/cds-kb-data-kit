...
| Field | Data Source |
|---|---|
| key `PhysicalInventoryDocNumber` | `_logHead.PhysicalInventoryDocNumber` |
| key `PhysicalInventoryDocYear` | `_logHead.PhysicalInventoryDocYear` |
| key `EWMWarehouse` | `_PIItem.EWMWarehouse` |
| key `PhysicalInventoryItemNumber` | `_PIItem.PhysicalInventoryItemNumber` |
