...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_EWM_RESOURCETYPETEXT_2')/$value) |
...
| `EWMResourceType` | `CHAR(4)` | Resource Type |
| `ResourceTypeName` | `CHAR(40)` | Description |
