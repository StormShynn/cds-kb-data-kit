...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_EWM_STORAGEPROCESS_2')/$value) |
...
| `StorageProcessCategory` | `CHAR(1)` | Storage Process Category |
