...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_EWM_RESOURCEGROUPTEXT_2')/$value) |
...
| `EWMResourceGroup` |  | |  |  | `CHAR(4)` | Resource Group |
| `ResourceGroupName` |  | |  |  | `CHAR(40)` | Description |
