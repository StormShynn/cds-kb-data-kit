...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_EWM_STOCKUSAGETEXT_2')/$value) |
...
| `StockUsageName` |  | |  |  | `CHAR(30)` | Short Text |
