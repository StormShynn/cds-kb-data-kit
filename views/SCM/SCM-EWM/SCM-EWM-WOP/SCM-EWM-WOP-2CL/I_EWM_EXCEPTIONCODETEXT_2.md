...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_EWM_EXCEPTIONCODETEXT_2')/$value) |
...
| `WarehouseTaskExceptionCode` |  | |  |  | `CHAR(4)` | Exception Code |
