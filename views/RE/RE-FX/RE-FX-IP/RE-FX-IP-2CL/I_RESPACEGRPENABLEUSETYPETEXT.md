...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_RESPACEGRPENABLEUSETYPETEXT')/$value) |
...
| `RESpaceGrpEnableUseTypeText` |  | |  |  | `CHAR(60)` | Description Usage Enablement Type |
