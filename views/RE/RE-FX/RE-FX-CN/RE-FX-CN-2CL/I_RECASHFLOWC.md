...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_RECASHFLOWC')/$value) |
...
| `REIndustrySector` | `CHAR(10)` | Industry |
| `REIsSalesRelevant` | `CHAR(1)` | Indicator: Relevant to Sales |
| `REContractNoticeReason` | `NUMC(2)` | Reason for Notice |
