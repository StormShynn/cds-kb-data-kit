...
| Field | Data Source |
|---|---|
| key `DocFlowPrecdgDocumentCategory` | `_DocumentFlow.pre_doc_type` |
| key `DocFlowPrecedingDocumentNumber` | `_DocumentFlow.pre_doc_id` |
| key `DocFlowPrecedingDocumentItem` | `_DocumentFlow.pre_doc_item` |
| key `DocFlowSubsqntDocumentCategory` | `_DocumentFlow.fol_doc_type` |
| key `DocFlowSubsqntDocumentNumber` | `_DocumentFlow.fol_doc_id` |
| key `DocFlowSubsequentDocumentItem` | `_DocumentFlow.fol_doc_item` |
| key `DSD_TourNumber` | `_DocumentFlow.tour_id` |
| key `DSD_RouteAccountingVisitNumber` | `_DocumentFlow.visit_id` |
| `Plant` | `_Header.plant` |
