...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SUBSCRPNBILLGPRCGSCALETYPE')/$value) |

## Fields

| Field | Type | Description |
|---|---|---|
| `SubscrpnBillgPricingScaleType` | `CHAR(1)` | Scale Type for Pricing |
