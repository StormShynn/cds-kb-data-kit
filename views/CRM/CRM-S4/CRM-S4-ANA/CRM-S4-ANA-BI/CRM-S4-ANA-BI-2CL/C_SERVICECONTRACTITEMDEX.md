...
| Field | Data Source |
|---|---|
| key `ServiceObjectType` | `ServiceContractItem.ServiceObjectType` |
| key `ServiceDocument` | `ServiceContractItem.ServiceDocument` |
| key `ServiceDocumentItem` | `ServiceContractItem.ServiceDocumentItem` |
