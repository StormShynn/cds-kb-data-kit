...
description: Credit Decision Document Query
...
semantic_en: Credit Decision Document Query
tags:
  - FIN
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CREDITDECISIONDOCUMENTQ')/$value) |
