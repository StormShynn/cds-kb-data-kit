...
semantic_en: Business Partner Groups
tags:
  - FIN
  - bo:project
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CRDTMBUSPARTNERGROUPVH')/$value) |
