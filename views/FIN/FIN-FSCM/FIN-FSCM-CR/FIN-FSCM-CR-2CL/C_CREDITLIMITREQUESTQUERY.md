...
description: Credit Limit Request Query
...
semantic_en: Credit Limit Request Query
tags:
  - FIN
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CREDITLIMITREQUESTQUERY')/$value) |
