...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CMMDTYTEXT')/$value) |
...
| `CommodityName` | `CHAR(40)` | Commodity Description |
