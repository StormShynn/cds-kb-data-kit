...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CMMDTYCATEGORYTEXT')/$value) |
...
| `CommodityCategoryName` | `CHAR(30)` | Commodity Category Text |
