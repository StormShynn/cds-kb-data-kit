...
description: Secnd Customer Specific Cmdty GrpName - Text
...
semantic_en: Secnd Customer Specific Cmdty GrpName - Text
tags:
  - FIN
  - bo:businesspartner
...
**Secnd Customer Specific Cmdty GrpName - Text**
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SECONDCMMDTYGROUPTEXT')/$value) |
