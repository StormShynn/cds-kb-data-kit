...
tags:
  ...
  - metadata-only
---
# _DCO_I_DSPUTTOTPROCSTPSTSTEXT

**Custom and Strd Proc Step Stat - Text**
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('_DCO_I_DSPUTTOTPROCSTPSTSTEXT')/$value) |
