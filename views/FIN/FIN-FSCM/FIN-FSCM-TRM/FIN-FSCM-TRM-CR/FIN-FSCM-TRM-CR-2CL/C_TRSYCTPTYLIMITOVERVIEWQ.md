...
description: This CDS view provides the prerequisites for answering the following business questions for limit utilizations based on limit types for credit risk: What are the limit utilization amounts in display currency at different dates for a specific limit type based on a specific limit utilization base by business partner? What are the free internal limit amounts in display currency at different dates for a specific limit type based on a specific limit utilization base by business partner? What are the limit utilization amounts in display currency at different dates for a specific limit type based on a specific limit utilization base by company code? What are the free internal limit amounts in display currency at different dates for a specific limit type based on a specific limit utilization base by business partner? What are the limit utilization amounts in display currency at different dates for a specific limit type based on a specific limit utilization base by limit product group? What are the free internal limit amounts in display currency at different dates for a specific limit type based on a specific limit utilization base by limit product group?
