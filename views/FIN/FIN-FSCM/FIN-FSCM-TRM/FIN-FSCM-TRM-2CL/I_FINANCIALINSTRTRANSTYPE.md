...
| Field | Data Source |
|---|---|
| key `FinancialInstrTransactionType` | `cast(FinancialInstrTransType.sfhaart as ftr_gen_transaction_type preserving type)` |
| key `FinancialInstrumentProductType` | `FinancialInstrTransType.sgsart` |
