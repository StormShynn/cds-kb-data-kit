...
description: Facility Transaction Category
...
semantic_en: Facility Transaction Category
tags:
  - FIN
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_FTR_FAC_TRANS_CAT_VH')/$value) |
