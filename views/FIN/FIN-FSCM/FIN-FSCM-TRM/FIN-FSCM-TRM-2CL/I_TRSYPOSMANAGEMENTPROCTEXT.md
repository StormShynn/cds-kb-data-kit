...
| Field | Data Source |
|---|---|
| key `TrsyPosManagementProcedure` | `cast(TrsyPosManagementProcedureText.pos_man_proc as ftr_gen_pos_man_proc preserving type)` |
| key `Language` | `TrsyPosManagementProcedureText.spras` |
