...
| Field | Data Source |
|---|---|
| key `TreasuryValuationArea` | `TreasuryValuationClass.valuation_area` |
| key `TreasuryValuationClass` | `cast(TreasuryValuationClass.valuation_class as ftr_gen_valuation_class preserving type)` |
