...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CNSLDTNCASHFLOWDYNAMICQ')/$value) |
...
| `ClsgFiscalYearToDateAmount` | `CURR(23)` | Actual Fiscal Year To Date Amount |
| `ClsgPrevFiscalYearToDateAmount` | `CURR(23)` | Previous Fiscal Year To Date Amount |
