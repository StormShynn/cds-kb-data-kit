...
description: Income Statement - Nature of Expense
...
semantic_en: Income Statement - Nature of Expense
keywords:
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CNSLDTNINCSTMNTNATROFEXPNQ')/$value) |
