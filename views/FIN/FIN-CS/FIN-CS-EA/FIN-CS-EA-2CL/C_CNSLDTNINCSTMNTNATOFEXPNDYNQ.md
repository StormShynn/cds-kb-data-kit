...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CNSLDTNINCSTMNTNATOFEXPNDYNQ')/$value) |
...
| `ClsgFiscalYearAmount` | `DEC(1)` |  |
| `PrevFiscalYearAmount` | `DEC(1)` |  |
| `DeltaClsgPrevFiscalYearAmount` | `DEC(2)` |  |
...
| `ClsgFiscalYearToDateAmount` | `DEC(23)` |  |
| `ClsgPrevFiscalYearToDateAmount` | `DEC(23)` |  |
| `DeltaClsgPrevFsclYTDAmount` | `DEC(24)` |  |
| `DeltaClsgPrevFsclYTDRatio` | `DECF(34)` |  |
| `FiscalYrPeriodPrevYrAmt` | `DEC(23)` |  |
| `DeltaActFsclYrPerdPrevYrAmt` | `DEC(24)` |  |
| `DeltaActFsclYrPerdPrevYrRatio` | `DECF(34)` |  |
| `ClsgFiscalPeriodAmount` | `DEC(23)` |  |
| `BudgetFiscalPeriodAmount` | `DEC(23)` |  |
| `DeltaActBdgtFsclPeriodAmount` | `DEC(24)` |  |
| `DeltaActBdgtFsclPeriodRatio` | `DECF(34)` |  |
| `ActualFiscalYearToDateAmount` | `DEC(23)` |  |
| `BudgetFiscalYearToDateAmount` | `DEC(23)` |  |
| `DeltaActBdgtFsclYearToDateAmt` | `DEC(24)` |  |
| `DeltaActBdgtFsclYTDRatio` | `DECF(34)` |  |
| `ActCnstntCrcyFsclPerdAmt` | `DEC(23)` |  |
| `DeltaActCnstntFsclYrPerdAmt` | `DEC(24)` |  |
| `DeltaBdgtActCnstntFYPerdAmt` | `DEC(24)` |  |
