...
| Field | Data Source |
|---|---|
| key `Language` | `cast( DomainText.ddlanguage as spras preserving type )` |
| key `ConsolidationTaskRunStatus` | `cast( left( DomainText.domvalue_l,2 ) as fincs_taskrun_status preserving type )` |
