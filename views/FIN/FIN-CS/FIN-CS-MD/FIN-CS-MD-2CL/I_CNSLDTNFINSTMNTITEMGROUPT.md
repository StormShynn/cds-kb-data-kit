...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CNSLDTNFINSTMNTITEMGROUPT')/$value) |
...
| `FinancialStatementItemGroup` |  | |  |  | `CHAR(10)` | Values for Domains: Single Value/Lower Limit |
| `FinancialStatementItemGroupTxt` |  | |  |  | `CHAR(60)` | Short Text for Fixed Values |
