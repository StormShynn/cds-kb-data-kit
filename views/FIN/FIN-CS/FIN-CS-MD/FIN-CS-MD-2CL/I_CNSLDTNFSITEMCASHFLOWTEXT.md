...
| Field | Data Source |
|---|---|
| key `Language` | `cast( _FSItemAttribValueTxt.Language as spras preserving type )` |
| key `CnsldtnFSItemCashFlow` | `cast( _FSItemAttribValueTxt.CnsldtnFSItemAttributeValue as fincs_fsitemcashflow preserving type )` |
