...
| key `CnsldtnSubitemCategory` | `_HierarchyText.CnsldtnSubitemCategory` |
| key `ConsolidationSubitemHierarchy` | `cast(_HierarchyText.CnsldtnUniversalHierarchy as fincs_subitemhierarchy preserving type )` |
