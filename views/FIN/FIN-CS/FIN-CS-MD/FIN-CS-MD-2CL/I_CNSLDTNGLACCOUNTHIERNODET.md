...
| key `ChartOfAccounts` | `_HierarchyNodeText.ChartOfAccounts` |
| key `CnsldtnGLAccountHierarchy` | `cast(_HierarchyNodeText.UniversalHierarchy as fincs_glaccounthierarchy preserving type )` |
