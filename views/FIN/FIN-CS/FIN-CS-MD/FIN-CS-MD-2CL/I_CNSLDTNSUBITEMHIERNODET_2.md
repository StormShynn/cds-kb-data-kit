...
| key `CnsldtnSubitemCategory` | `_HierarchyNodeText.CnsldtnSubitemCategory` |
| key `ConsolidationSubitemHierarchy` | `cast( _HierarchyNodeText.CnsldtnUniversalHierarchy as fincs_subitemhierarchy preserving type )` |
