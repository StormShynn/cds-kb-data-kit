...
| Field | Data Source |
|---|---|
| key `Language` | `cast(_Text.langu as fincs_language preserving type )` |
| key `ConsolidationInvestmentMethod` | `cast(_Text.cmeth as fincs_investmentmethod preserving type )` |
