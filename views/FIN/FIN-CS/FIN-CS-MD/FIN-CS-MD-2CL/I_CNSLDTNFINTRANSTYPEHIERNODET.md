...
| key `CnsldtnFinTransTypeHierarchy` | `cast(_Source.CnsldtnUniversalHierarchy as fincs_fintransactiontypehier preserving type )` |
| key `HierarchyNode` | `_Source.HierarchyNode` |
| key `ValidityEndDate` | `_Source.ValidityEndDate` |
