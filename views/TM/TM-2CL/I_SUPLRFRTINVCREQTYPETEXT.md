...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SUPLRFRTINVCREQTYPETEXT')/$value) |

## Fields

| Field | Key | Association | Via | Source | Type | Description |
|---|---|---|---|---|---|---|
| `SuplrFrtInvcReqType` |  | |  |  | `CHAR(4)` | Type |
| `Language` |  | |  |  | `LANG(1)` | Language Key |
| `SuplrFrtInvcReqTypeDesc` |  | |  |  | `CHAR(40)` | Freight Settlement Document Type Description |
