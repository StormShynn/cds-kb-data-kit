...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_LOANTYPETEXT')/$value) |
...
| `LoanTypeShortText` |  | |  |  | `CHAR(15)` | Short Name |
| `LoanTypeText` |  | |  |  | `CHAR(50)` | Name |
