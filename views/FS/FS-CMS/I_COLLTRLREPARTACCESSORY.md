...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_COLLTRLREPARTACCESSORY')/$value) |
...
| `ColltrlREPrtAccsryConvertedID` | `CHAR(40)` | Reference ID for the object |
