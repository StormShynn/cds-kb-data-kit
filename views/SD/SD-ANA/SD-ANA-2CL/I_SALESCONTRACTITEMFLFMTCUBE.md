...
| Field | Data Source |
|---|---|
| key `SalesContract` | `cast( SCIA.SalesDocument as sales_contract preserving type )` |
| key `SalesContractItem` | `cast( SCIA.SalesDocumentItem as sales_contract_item preserving type )` |
