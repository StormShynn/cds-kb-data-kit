...
| Field | Data Source |
|---|---|
| key `SalesOrderWithoutCharge` | `cast(SalesDocument as sales_order_without_charge preserving type)` |
| key `SalesOrderWithoutChargeItem` | `cast(SalesDocumentItem as sales_order_without_charge_itm preserving type)` |
