...
| Field | Data Source |
|---|---|
| key `SalesOrder` | `cast(SalesDocumentScheduleLine.SalesDocument as vdm_sales_order preserving type)` |
| key `SalesOrderItem` | `cast(SalesDocumentScheduleLine.SalesDocumentItem as sales_order_item preserving type)` |
