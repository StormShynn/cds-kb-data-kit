...
| Field | Data Source |
|---|---|
| key `SalesContract` | `SDPartner.SalesContract` |
| key `PartnerFunction` | `SDPartner.PartnerFunction` |
| key `SDDocPartnerSequenceNumber` | `SDPartner.SDDocPartnerSequenceNumber` |
