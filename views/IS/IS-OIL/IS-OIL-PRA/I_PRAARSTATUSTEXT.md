...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_PRAARSTATUSTEXT')/$value) |
...
| `AcctsRblStatusName` | `CHAR(60)` | AR Balance Status Name |
