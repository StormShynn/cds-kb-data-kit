...
**Office of Natural Resources Revenue Processing Exception**
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ONRRPROCESSINGEXCEPTION')/$value) |
