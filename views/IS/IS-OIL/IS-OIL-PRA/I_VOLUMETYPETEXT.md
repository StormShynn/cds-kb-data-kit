...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_VOLUMETYPETEXT')/$value) |
...
| `VolumeTypeName` |  | |  |  | `CHAR(50)` | Volume Type Description |
