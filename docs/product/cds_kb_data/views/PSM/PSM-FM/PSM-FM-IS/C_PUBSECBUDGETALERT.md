---
name: C_PUBSECBUDGETALERT
description: "Public Sector Budget Alert Analysis"
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_PUBSECBUDGETALERT')/$value
semantic_en: "Public Sector Budget Alert Analysis"
semantic_vi: "Public Sector Budget Alert Analysis — CDS view tiêu dùng dựa trên I_PubSecBudgetAlert."
keywords:
  - "public"
  - "sector"
  - "budget"
...
**Public Sector Budget Alert Analysis**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_PUBSECBUDGETALERT')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_PUBSECBUDGETALERT')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_PUBSECBUDGETALERT')/$value)*

```abap
@AbapCatalog.sqlViewName: 'CPSBDGTALERTC'
@ClientHandling.algorithm: #SESSION_VARIABLE
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@AccessControl.personalData.blocking: #NOT_REQUIRED
@EndUserText.label: 'Public Sector Budget Alert Analysis'
...
define view C_PubSecBudgetAlert
  with parameters
  ...
  as select from I_PubSecBudgetAlert(  P_PubSecBdgtAcctRevnExpnCode: :P_PubSecBdgtAcctRevnExpnCode,
