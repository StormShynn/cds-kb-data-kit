...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SPONSOREDCLASSTYPETEXTCORE')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SPONSOREDCLASSTYPETEXTCORE')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SPONSOREDCLASSTYPETEXTCORE')/$value)*

```abap
@AbapCatalog.sqlViewName: 'IGMSPCLTYPETCE'
...
define view I_SponsoredClassTypeTextCore as select from dd07t
  association        to parent I_SponsoredClassTypeCore as _SponsoredClassType on $projection.SponsoredClassType = _SponsoredClassType.SponsoredClassType
