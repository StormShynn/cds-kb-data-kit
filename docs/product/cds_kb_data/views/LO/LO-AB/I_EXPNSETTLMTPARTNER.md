...
semantic_vi: "Expense Settlement Partner — CDS view cơ bản dựa trên R_ExpnSettlmtPartner."
keywords:
  - "expense"
  - "settlement"
  - "partner"
...
@Analytics.technicalName: 'IWLFEXPNSMTPART'

@EndUserText.label: 'Expense Settlement Partner'
@Metadata.ignorePropagatedAnnotations: true
@Metadata.allowExtensions:true

define view entity I_ExpnSettlmtPartner
  as select from R_ExpnSettlmtPartner
