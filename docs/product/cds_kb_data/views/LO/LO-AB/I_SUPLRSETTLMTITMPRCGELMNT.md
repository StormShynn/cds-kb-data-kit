---
name: I_SUPLRSETTLMTITMPRCGELMNT
description: "Supplier Settlement Item Pricing Element"
app_component: LO-AB
software_component: SAPSCORE
release_state: released
system_type: S/4HANA Cloud Public Edition
source_available: true
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SUPLRSETTLMTITMPRCGELMNT')/$value
semantic_en: "Supplier Settlement Item Pricing Element"
semantic_vi: "Supplier Settlement Item Pricing Element — CDS view cơ bản dựa trên R_SuplrSettlmtItmPrcgElmnt."
keywords:
  - "supplier"
  - "settlement"
  - "item"
...
tags:
  ...
  - supplier
---
# I_SUPLRSETTLMTITMPRCGELMNT

**Supplier Settlement Item Pricing Element**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SUPLRSETTLMTITMPRCGELMNT')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SUPLRSETTLMTITMPRCGELMNT')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SUPLRSETTLMTITMPRCGELMNT')/$value)*

```abap
@EndUserText.label: 'Supplier Settlement Item Pricing Element'
@AccessControl: {
...
define view entity I_SuplrSettlmtItmPrcgElmnt
  as select from R_SuplrSettlmtItmPrcgElmnt
