...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SETTLMTPARTNERCATTEXT')/$value) |
...
| `SettlmtPartnerCatName` |  | |  |  | `CHAR(60)` | Description of Settlement Partner Category |
