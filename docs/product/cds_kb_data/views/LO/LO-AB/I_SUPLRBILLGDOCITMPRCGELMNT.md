---
name: I_SUPLRBILLGDOCITMPRCGELMNT
description: "Supplier Billing Document Item Pricing Element"
app_component: LO-AB
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SUPLRBILLGDOCITMPRCGELMNT')/$value
semantic_en: "Supplier Billing Document Item Pricing Element"
semantic_vi: "I_SUPLRBILLGDOCITMPRCGELMNT — CDS view cơ bản dựa trên R_SuplrBillgDocItmPrcgElmnt."
keywords:
  - "suplrbillgdocitmprcgelmnt"
  - "suplr"
  - "billg"
  - "item"
  - "pricing"
...
tags:
  ...
  - supplier
---
# I_SUPLRBILLGDOCITMPRCGELMNT

**Supplier Billing Document Item Pricing Element**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SUPLRBILLGDOCITMPRCGELMNT')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SUPLRBILLGDOCITMPRCGELMNT')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SUPLRBILLGDOCITMPRCGELMNT')/$value)*

```abap
@EndUserText: {
  label: 'Suplr Billg Doc Item Pricing Element'
}
@VDM: {
  viewType: #BASIC,
...
define view entity I_SuplrBillgDocItmPrcgElmnt
  as select from R_SuplrBillgDocItmPrcgElmnt
