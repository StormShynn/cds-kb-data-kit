...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CUSTOMERSETTLMTSTATUSTXT')/$value) |
...
| `CustomerSettlmtStatusName` |  | |  |  | `CHAR(60)` | Settlement Status - Customer Description |
