...
semantic_vi: "I_SUPLRBILLGDOCPRCGELMNT — CDS view cơ bản dựa trên R_SuplrBillgDocPrcgElmnt."
keywords:
...
```abap
@EndUserText: {
  label: 'Suplr Billing Document Pricing Element'
}
@VDM: {
  viewType: #BASIC,
...
define view entity I_SuplrBillgDocPrcgElmnt
  as select from R_SuplrBillgDocPrcgElmnt
