...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CNDNCONTRSETTLMTLOCKTEXT')/$value) |

## Fields

| Field | Key | Association | Via | Source | Type | Description |
|---|---|---|---|---|---|---|
| `CndnContrSettlmtIsLocked` |  | |  |  | `CHAR(1)` | Settlement Lock Status |
| `Language` |  | |  |  | `LANG(1)` | Language Key |
| `CndnContrSettlmtIsLockedName` |  | |  |  | `CHAR(60)` | Settlement Lock Status Text |
