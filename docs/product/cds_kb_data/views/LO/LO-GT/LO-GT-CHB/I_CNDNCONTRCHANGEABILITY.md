...
semantic_vi: "Condition Contract Changeability — CDS view cơ bản dựa trên dd07l."
keywords:
  - "condition"
  - "contract"
  - "changeability"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CNDNCONTRCHANGEABILITY')/$value) |

## Fields

| Field | Key | Association | Via | Source | Type | Description |
|---|---|---|---|---|---|---|
| `CndnContrChangeability` | ✓ | |  | `cast(dd07l.domvalue_l as wcb_ui_change )` | `CHAR(2)` | Control for Changes on the User Interface |
| `DomainValue` |  | |  | `domvalue_l` | `CHAR(10)` | Values for Domains: Single Value/Lower Limit |
| `_Text` | | ✓ | | | | |

## Source Code

*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CNDNCONTRCHANGEABILITY')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CNDNCONTRCHANGEABILITY')/$value)*

```abap
@EndUserText.label: 'Condition Contract Changeability'
@AccessControl: {
  authorizationCheck: #NOT_REQUIRED
}
@ObjectModel: {
  sapObjectNodeType.name: 'ConditionContractChangeability',
...
define root view entity I_CndnContrChangeability
  as select from dd07l
  
  composition [0..*] of I_CndnContrChangeabilityText as _Text
  
{
      @ObjectModel.text.association: '_Text'
  key cast(dd07l.domvalue_l as wcb_ui_change )               as CndnContrChangeability,
