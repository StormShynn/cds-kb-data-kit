...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_DEPRECIATIONKEYTEXT')/$value) |
...
| `DepreciationKeyName` |  | |  |  | `CHAR(50)` | Depreciation Key Name |
