...
description: "This CDS view provides the prerequisites for answering the following business questions: What are the actual amounts for each cost center and G/L account in transaction currency? What are the actual amounts for each cost center and G/L account in company code currency? What are the actual amounts for each cost center and G/L account in global currency? For all three currency types, you can drill down for further relevant characteristics."
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_COSTCENTERQ2001')/$value
semantic_en: "This CDS view provides the prerequisites for answering the following business questions: What are the actual amounts for each cost center and G/L account in transaction currency? What are the actual amounts for each cost center and G/L account in company code currency? What are the actual amounts for each cost center and G/L account in global currency? For all three currency types, you can drill down for further relevant characteristics."
semantic_vi: "Cost Centers Actuals — CDS view tiêu dùng dựa trên I_JournalEntryItemCube."
keywords:
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_COSTCENTERQ2001')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_COSTCENTERQ2001')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_COSTCENTERQ2001')/$value)*

```abap
@AbapCatalog.sqlViewName: 'CFICOSTCTRQ2001'
@EndUserText.label: 'Cost Centers Actuals'
