---
name: C_TRIALBALANCE
description: "This CDS view can form balances of various dimensions of the journal entry including the most important business entities, such as the G/L account, company code, cost center and profit center. Other attributes and hierarchies can be reached via associations. The CDS view also contains postings of carryforward balances. This CDS view provides the prerequisites for answering the following business questions: What are the G/L account balances and G/L account ending balances of a specific time frame? What is the balance of a cost center for a specific time frame? What are balances within the G/L account hierarchy? What is the revenue drilled down by profit center?"
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_TRIALBALANCE')/$value
semantic_en: "This CDS view can form balances of various dimensions of the journal entry including the most important business entities, such as the G/L account, company code, cost center and profit center. Other attributes and hierarchies can be reached via associations. The CDS view also contains postings of carryforward balances. This CDS view provides the prerequisites for answering the following business questions: What are the G/L account balances and G/L account ending balances of a specific time frame? What is the balance of a cost center for a specific time frame? What are balances within the G/L account hierarchy? What is the revenue drilled down by profit center?"
...
**This CDS view can form balances of various dimensions of the journal entry including the most important business entities, such as the G/L account, company code, cost center and profit center. Other attributes and hierarchies can be reached via associations. The CDS view also contains postings of carryforward balances. This CDS view provides the prerequisites for answering the following business questions: What are the G/L account balances and G/L account ending balances of a specific time frame? What is the balance of a cost center for a specific time frame? What are balances within the G/L account hierarchy? What is the revenue drilled down by profit center?**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_TRIALBALANCE')/$value) |
...
| `GLAccountHierarchy` |  | |  | `cast(I_GLAcctBalanceCube.GLAccountHierarchy as racct)` | `CHAR(10)` | Account Number |
| `GLAccountHierarchyName` |  | |  | `I_GLAcctBalanceCube._GLAccountInChartOfAccounts._Text[1: Language = $parameters.P_Language].GLAccountName` | `CHAR(20)` | G/L Account Name |
| `PostingDate` |  | |  | `cast( I_GLAcctBalanceCube.PostingDate as budat preserving type )` | `DATS(8)` | Posting Date in the Document |
...
| `SenderCostCenterName` |  | |  | `cast( I_GLAcctBalanceCube._PartnerCostCenter[1:ValidityEndDate >= $parameters.P_KeyDate and ValidityStartDate <= $parameters.P_KeyDate]._Text[1:Language = $parameters.P_Language].CostCenterName as fis_partner_kostl_name preserving type )` | `CHAR(20)` | Partner Cost Center Name |
| `PartnerProfitCenter` |  | |  |  | `CHAR(10)` | Partner Profit Center |
| `PartnerProfitCenterName` |  | |  | `cast( I_GLAcctBalanceCube._PartnerProfitCenter[1:ValidityEndDate >= $parameters.P_KeyDate and ValidityStartDate <= $parameters.P_KeyDate]._Text[1:Language = $parameters.P_Language].ProfitCenterName as fis_partner_prctr_short_name preserving type )` | `CHAR(20)` | Partner Profit Center Name |
| `PartnerFunctionalArea` |  | |  |  | `CHAR(16)` | Partner Functional Area |
| `PartnerFunctionalAreaName` |  | |  | `cast( I_GLAcctBalanceCube._PartnerFunctionalArea._Text[1:Language = $parameters.P_Language].FunctionalAreaName as fis_pfkbtx preserving type )` | `CHAR(25)` | Name of the Partner Functional Area |
| `PartnerBusinessArea` |  | |  |  | `CHAR(4)` | Partner Business Area |
| `PartnerBusinessAreaName` |  | |  | `cast( I_GLAcctBalanceCube._PartnerBusinessArea._Text[1:Language = $parameters.P_Language].BusinessAreaName as fis_partner_gtext_vdm preserving type )` | `CHAR(30)` | Partner Business Area Name |
| `PartnerCompany` |  | |  |  | `CHAR(6)` | Company ID of Trading Partner |
| `PartnerSegment` |  | |  |  | `CHAR(10)` | Partner Segment for Segmental Reporting |
| `PartnerSegmentName` |  | |  | `cast( I_GLAcctBalanceCube._PartnerSegment._Text[1:Language = $parameters.P_Language].SegmentName as fis_partner_segment_name preserving type )` | `CHAR(50)` | Partner Segment Name |
...
| `PostingKeyName` |  | |  | `I_GLAcctBalanceCube._PostingKey._PostingKeyText[1:Language = $parameters.P_Language].PostingKeyName` | `CHAR(20)` | Posting Key Name |
...
| `EliminationProfitCenterName` |  | |  | `cast( I_GLAcctBalanceCube._EliminationProfitCenter[1:ValidityEndDate >= $parameters.P_KeyDate and ValidityStartDate <= $parameters.P_KeyDate]._Text[1:Language = $parameters.P_Language].ProfitCenterName as fis_eprctr_name preserving type )` | `CHAR(20)` | Elimination Profit Center Name |
...
| `MaterialName` |  | |  | `I_GLAcctBalanceCube._Product._Text[1:Language = $parameters.P_Language].ProductName` | `CHAR(40)` | Product Description |
| `Plant` |  | |  |  | `CHAR(4)` | Plant |
...
| `InvtrySpecialStockSupplierName` |  | |  | `cast( I_GLAcctBalanceCube._InventorySpecialStockSupplier.SupplierName as fis_mlmat_lifnr_name preserving type )` | `CHAR(80)` | Inventory Special Stock Supplier Name |
...
| `PartnerWBSElementExternalID` |  | |  | `cast( I_GLAcctBalanceCube._PartnerWBSElementBasicData.WBSElementExternalID as fis_partner_wbsext_no_conv )` | `CHAR(24)` | Partner WBS Element External ID |
| `PartnerProject` |  | |  |  | `CHAR(24)` | Partner Project |
| `PartnerProjectExternalID` |  | |  | `cast( I_GLAcctBalanceCube._PartnerProjectBasicData.ProjectExternalID as fis_part_projectext_no_conv )` | `CHAR(24)` | Partner Project External ID |
...
| `MaterialGroupName` |  | |  | `I_GLAcctBalanceCube._SoldProductGroup_2._ProductGroupText[1:Language = $parameters.P_Language].ProductGroupName` | `CHAR(20)` | Product Group Description |
...
| `StrtgBalAmtInFreeDfndCrcy1` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_osl_ui )` | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 1 |
| `DebitAmountInFreeDfndCrcy1` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_osl )` | `CURR(23)` | Debit Balance in Freely Defined Currency 1 |
| `CreditAmountInFreeDfndCrcy1` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_osl )` | `CURR(23)` | Credit Balance in Freely Defined Currency 1 |
...
| `StrtgBalAmtInFreeDfndCrcy2` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_vsl_ui )` | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 2 |
| `DebitAmountInFreeDfndCrcy2` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_vsl )` | `CURR(23)` | Debit Balance in Freely Defined Currency 2 |
| `CreditAmountInFreeDfndCrcy2` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_vsl )` | `CURR(23)` | Credit Balance in Freely Defined Currency 2 |
...
| `StrtgBalAmtInFreeDfndCrcy3` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_bsl_ui )` | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 3 |
| `DebitAmountInFreeDfndCrcy3` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_bsl )` | `CURR(23)` | Debit Balance in Freely Defined Currency 3 |
| `CreditAmountInFreeDfndCrcy3` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_bsl )` | `CURR(23)` | Credit Balance in Freely Defined Currency 3 |
...
| `StrtgBalAmtInFreeDfndCrcy4` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_csl )` | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 4 |
| `DebitAmountInFreeDfndCrcy4` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_csl )` | `CURR(23)` | Debit Balance in Freely Defined Currency 4 |
| `CreditAmountInFreeDfndCrcy4` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_csl )` | `CURR(23)` | Credit Balance in Freely Defined Currency 4 |
...
| `StrtgBalAmtInFreeDfndCrcy5` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_dsl )` | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 5 |
| `DebitAmountInFreeDfndCrcy5` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_dsl )` | `CURR(23)` | Debit Balance in Freely Defined Currency 5 |
| `CreditAmountInFreeDfndCrcy5` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_dsl )` | `CURR(23)` | Credit Balance in Freely Defined Currency 5 |
...
| `StrtgBalAmtInFreeDfndCrcy6` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_esl )` | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 6 |
| `DebitAmountInFreeDfndCrcy6` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_esl )` | `CURR(23)` | Debit Balance in Freely Defined Currency 6 |
| `CreditAmountInFreeDfndCrcy6` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_esl )` | `CURR(23)` | Credit Balance in Freely Defined Currency 6 |
...
| `StrtgBalAmtInFreeDfndCrcy7` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_fsl_ui )` | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 7 |
| `DebitAmountInFreeDfndCrcy7` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_fsl )` | `CURR(23)` | Debit Balance in Freely Defined Currency 7 |
| `CreditAmountInFreeDfndCrcy7` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_fsl )` | `CURR(23)` | Credit Balance in Freely Defined Currency 7 |
...
| `StrtgBalAmtInFreeDfndCrcy8` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_gsl )` | `CURR(23)` | Starting Balance Amount In Freely Defined Currency 8 |
| `DebitAmountInFreeDfndCrcy8` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_gsl )` | `CURR(23)` | Debit Balance in Freely Defined Currency 8 |
| `CreditAmountInFreeDfndCrcy8` |  | |  | `cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_gsl )` | `CURR(23)` | Credit Balance in Freely Defined Currency 8 |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_TRIALBALANCE')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_TRIALBALANCE')/$value)*

```abap
@AbapCatalog.sqlViewName: 'CFITRIALBALANCE'
...
I_GLAcctBalanceCube.Ledger,

@Consumption.filter: {selectionType: #SINGLE, multipleSelections: true, mandatory: true}
@AnalyticsDetails.query.variableSequence : 20
@AnalyticsDetails.query.axis: #ROWS
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CompanyCode,
I_GLAcctBalanceCube._CompanyCode.CompanyCodeName,
...
cast(I_GLAcctBalanceCube.GLAccountHierarchy as racct) as GLAccountHierarchy,
I_GLAcctBalanceCube._GLAccountInChartOfAccounts._Text[1: Language = $parameters.P_Language].GLAccountName as GLAccountHierarchyName,

//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: true}
//@AnalyticsDetails.query.variableSequence : 40
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
cast( I_GLAcctBalanceCube.PostingDate as budat preserving type ) as PostingDate,

//@Consumption.filter: {selectionType: #SINGLE, multipleSelections: false, mandatory: false}
@AnalyticsDetails.query.variableSequence : 50
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FiscalYear,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.LedgerFiscalYear,
//@AnalyticsDetails.query.axis: #FREE
//@AnalyticsDetails.query.totals: #SHOW
//GLRecordType,
//rldnr_pers,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FinancialTransactionType,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.BusinessTransactionType,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ReferenceDocumentType,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.LogicalSystem,
//@AnalyticsDetails.query.axis: #FREE
//@AnalyticsDetails.query.totals: #SHOW
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ReferenceDocumentItemGroup,
//SUBTA,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.IsReversal,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.IsReversed,
//XTRUEREV,
//AWTYP_REV,
//@AnalyticsDetails.query.axis: #FREE
//@AnalyticsDetails.query.totals: #SHOW
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.IsSettlement,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.IsSettled,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PredecessorReferenceDocType,
//@AnalyticsDetails.query.axis: #FREE
//@AnalyticsDetails.query.totals: #SHOW
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ProfitCenter,
I_GLAcctBalanceCube._ProfitCenter[1:ValidityEndDate   >= $parameters.P_KeyDate and 
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FunctionalArea,
I_GLAcctBalanceCube._FunctionalArea._Text[1:Language = $parameters.P_Language].FunctionalAreaName,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 95
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.BusinessArea,
I_GLAcctBalanceCube._BusinessArea._Text[1:Language = $parameters.P_Language].BusinessAreaName,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 90
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ControllingArea,
I_GLAcctBalanceCube._ControllingArea.ControllingAreaName,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 80
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.Segment,
I_GLAcctBalanceCube._Segment._Text[1:Language = $parameters.P_Language].SegmentName,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 305
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerCostCenter,
cast( I_GLAcctBalanceCube._PartnerCostCenter[1:ValidityEndDate  >= $parameters.P_KeyDate and 
                     ValidityStartDate <= $parameters.P_KeyDate]._Text[1:Language = $parameters.P_Language].CostCenterName  as fis_partner_kostl_name preserving type ) as SenderCostCenterName,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 310
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerProfitCenter,
cast( I_GLAcctBalanceCube._PartnerProfitCenter[1:ValidityEndDate   >= $parameters.P_KeyDate and 
                       ValidityStartDate <= $parameters.P_KeyDate]._Text[1:Language = $parameters.P_Language].ProfitCenterName as fis_partner_prctr_short_name preserving type ) as PartnerProfitCenterName,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 315
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerFunctionalArea,
cast( I_GLAcctBalanceCube._PartnerFunctionalArea._Text[1:Language = $parameters.P_Language].FunctionalAreaName as fis_pfkbtx preserving type ) as PartnerFunctionalAreaName,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 320
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerBusinessArea,
cast( I_GLAcctBalanceCube._PartnerBusinessArea._Text[1:Language = $parameters.P_Language].BusinessAreaName as fis_partner_gtext_vdm preserving type ) as PartnerBusinessAreaName,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 325
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerCompany,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 330
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerSegment,
cast( I_GLAcctBalanceCube._PartnerSegment._Text[1:Language = $parameters.P_Language].SegmentName as fis_partner_segment_name preserving type ) as PartnerSegmentName,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.DebitCreditCode,
I_GLAcctBalanceCube._DebitCreditCode._Text[1:Language = $parameters.P_Language].DebitCreditCodeName,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FiscalYearVariant,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 990
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FiscalYearPeriod,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
//@AnalyticsDetails.query.variableSequence : 995
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FiscalPeriod,
//bldat,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.AccountingDocumentType,
I_GLAcctBalanceCube._AccountingDocumentType._Text[1:Language = $parameters.P_Language].AccountingDocumentTypeName,
//buzei,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.AssignmentReference,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PostingKey,
//_PostingKey._Text[1:Language = $parameters.P_Language].PostingKeyName,
I_GLAcctBalanceCube._PostingKey._PostingKeyText[1:Language = $parameters.P_Language].PostingKeyName as PostingKeyName,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.AccountingDocumentCategory,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.TransactionTypeDetermination,
//@AnalyticsDetails.query.axis: #FREE
//@AnalyticsDetails.query.totals: #SHOW
//SubLedgerAcctLineItemType,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.AccountingDocCreatedByUser,
//timestamp,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.EliminationProfitCenter,
cast( I_GLAcctBalanceCube._EliminationProfitCenter[1:ValidityEndDate   >= $parameters.P_KeyDate and 
                       ValidityStartDate <= $parameters.P_KeyDate]._Text[1:Language = $parameters.P_Language].ProfitCenterName as fis_eprctr_name preserving type ) as EliminationProfitCenterName,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.OriginObjectType,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.GLAccountType,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ChartOfAccounts,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 161
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@AnalyticsDetails.query.display: #KEY_TEXT
I_GLAcctBalanceCube.AlternativeGLAccount,
//_AlternativeGLAccount._Text[1: Language = $parameters.P_Language].GLAccountName as AlternativeGLAccountName,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CountryChartOfAccounts,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PurchasingDocument,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PurchasingDocumentItem,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.AccountAssignmentNumber,
//@AnalyticsDetails.query.axis: #FREE
//@AnalyticsDetails.query.totals: #SHOW
//DocumentItemText,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.Material,

@AnalyticsDetails.query.variableSequence : 105
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.Product,
//_Material._Text[1:Language = $parameters.P_Language].MaterialName,
//_Product._MaterialText[1:Language = $parameters.P_Language].ProductDescription as MaterialName,
I_GLAcctBalanceCube._Product._Text[1:Language = $parameters.P_Language].ProductName as MaterialName,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 100
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.Plant,
I_GLAcctBalanceCube._Plant.PlantName,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.Supplier,
I_GLAcctBalanceCube._Supplier.SupplierName,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.Customer,
I_GLAcctBalanceCube._Customer.CustomerName,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FinancialAccountType,
I_GLAcctBalanceCube._FinancialAccountType._Text[1:Language = $parameters.P_Language].FinancialAccountTypeName,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SpecialGLCode,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.TaxCode,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.HouseBank,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.HouseBankAccount,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.IsOpenItemManaged,
//augdt,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ClearingAccountingDocument,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ClearingDocFiscalYear,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ClearingJournalEntry,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ClearingJournalEntryFiscalYear,
//@AnalyticsDetails.query.axis: #FREE
//@AnalyticsDetails.query.totals: #SHOW
//IsCleared,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.AssetDepreciationArea,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 110
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.MasterFixedAsset,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 120
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FixedAsset,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.AssetValueDate,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.AssetTransactionType,
//@AnalyticsDetails.query.axis: #FREE
//@AnalyticsDetails.query.totals: #SHOW
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.GroupMasterFixedAsset,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 130
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.GroupFixedAsset,
//settlement_rule,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.InventorySpecialStockValnType,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.InvtrySpecialStockValnType_2,
//xobew,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.InventorySpecialStockType,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.InventorySpclStkSalesDocument,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.InventorySpclStkSalesDocItm,
@API.element.releaseState: #DEPRECATED
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.InventorySpclStockWBSElement,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.InvtrySpclStockWBSElmntExtID,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.InvtrySpclStockWBSElmntIntID,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.InventorySpecialStockSupplier,
cast( I_GLAcctBalanceCube._InventorySpecialStockSupplier.SupplierName as fis_mlmat_lifnr_name preserving type ) as InvtrySpecialStockSupplierName,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.InventoryValuationType,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ValuationArea,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SenderGLAccount,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SenderAccountAssignment,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SenderAccountAssignmentType,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ControllingObjectDebitType,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.QuantityIsIncomplete,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.OffsettingAccount,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.OffsettingAccountType,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.LineItemIsCompleted,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 140
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PersonnelNumber,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ControllingObjectClass,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerCompanyCode,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerControllingObjectClass,
//aufnr_org,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 330
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.OriginCostCenter,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 335
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.OriginCostCtrActivityType,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 150
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.AccountAssignment,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.AccountAssignmentType,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 210
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ProjectNetwork,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.RelatedNetworkActivity,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 220
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.BusinessProcess,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 230
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CostObject,
//bemot,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CustomerServiceNotification,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.OperatingConcern,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 340
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerAccountAssignment,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerAccountAssignmentType,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 345
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerCostCtrActivityType,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 350
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerOrder,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 355
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerOrderCategory,
@API.element.releaseState: #DEPRECATED
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerWBSElement,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
cast( I_GLAcctBalanceCube._PartnerWBSElementBasicData.WBSElementExternalID as fis_partner_wbsext_no_conv ) as PartnerWBSElementExternalID,
@API.element.releaseState: #DEPRECATED
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerProject,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
cast( I_GLAcctBalanceCube._PartnerProjectBasicData.ProjectExternalID as fis_part_projectext_no_conv ) as PartnerProjectExternalID,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 370
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerSalesDocument,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerSalesDocumentItem,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 375
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerProjectNetwork,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerProjectNetworkActivity,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 380
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerBusinessProcess,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 385
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.PartnerCostObject,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.BillingDocumentType,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 250
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SalesOrganization,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 260
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.DistributionChannel,
@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 270
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.OrganizationDivision,
@API.element.releaseState: #DEPRECATED
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SoldMaterial,

@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 280
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SoldProduct,
@API.element.releaseState: #DEPRECATED
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.MaterialGroup,

@AnalyticsDetails.query.variableSequence : 290
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SoldProductGroup,
@API.element.releaseState: #DEPRECATED
@API.element.successor:   'SoldProductGroup'
//@VDM.lifecycle.status:    #DEPRECATED
//@VDM.lifecycle.successor: 'SoldProductGroup'
...
I_GLAcctBalanceCube.ProductGroup,
// Keep field name as MaterialGroupName, but replace it with ProductGroupName for CDS release purpose.
//_MaterialGroup._Text[1:Language = $parameters.P_Language].MaterialGroupName,
I_GLAcctBalanceCube._SoldProductGroup_2._ProductGroupText[1:Language = $parameters.P_Language].ProductGroupName as MaterialGroupName,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CustomerGroup,
I_GLAcctBalanceCube._CustomerGroup._Text[1:Language = $parameters.P_Language].CustomerGroupName,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.JointVenture,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.JointVentureEquityGroup,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.JointVentureCostRecoveryCode,
//vptnr,
//btype,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.JointVentureEquityType,
//prodper,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SettlementReferenceDate,
//pswenr,
//psgenr,
//psgrnr,
//psmenr,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CostCenter,
I_GLAcctBalanceCube._CostCenter[1:ValidityEndDate   >= $parameters.P_KeyDate and 
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CostCtrActivityType,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.OrderID,
//@Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
@AnalyticsDetails.query.variableSequence : 190
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.OrderCategory,
@API.element.releaseState: #DEPRECATED
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.WBSElement,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.WBSElementExternalID,
@API.element.releaseState: #DEPRECATED
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.Project,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW

I_GLAcctBalanceCube.ProjectExternalID,
@API.element.releaseState: #DEPRECATED
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SalesOrder,
@API.element.releaseState: #DEPRECATED
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SalesOrderItem,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SalesDocument,
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.SalesDocumentItem,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.ClearingDate,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.CompanyCodeCurrency,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.GlobalCurrency,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.FreeDefinedCurrency1,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.FreeDefinedCurrency2,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.FreeDefinedCurrency3,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.FreeDefinedCurrency4,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.FreeDefinedCurrency5,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.FreeDefinedCurrency6,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.FreeDefinedCurrency7,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.FreeDefinedCurrency8,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.BalanceTransactionCurrency,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.TransactionCurrency,

@AnalyticsDetails.query.axis: #FREE
//@Consumption.hidden: true
I_GLAcctBalanceCube.FiscalPeriodDate,

@AnalyticsDetails.query.axis: #FREE
//@Consumption.hidden: true
I_GLAcctBalanceCube.FiscalPeriodEndDate,

@AnalyticsDetails.query.axis: #FREE
//@Consumption.hidden: true
I_GLAcctBalanceCube.FiscalPeriodStartDate,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CalendarYear,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CalendarQuarter,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CalendarYearQuarter,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CalendarMonth,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CalendarYearMonth,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CalendarWeek,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CalendarYearWeek,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FiscalQuarter,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FiscalWeek,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FiscalYearQuarter,

@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.FiscalYearWeek,
...
@AnalyticsDetails.query.totals: #SHOW
@AnalyticsDetails.query.display: #KEY_TEXT
I_GLAcctBalanceCube.CorporateGroupAccount,
...
@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
I_GLAcctBalanceCube.CorporateGroupChartOfAccounts,

//@Consumption.filter: {selectionType: #SINGLE, multipleSelections: false, mandatory: false}
@AnalyticsDetails.query.variableSequence : 999
@AnalyticsDetails.query.axis: #FREE
I_GLAcctBalanceCube.IsBalanceSheetAccount,
...
@Semantics.amount.currencyCode: 'CompanyCodeCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalanceAmtInCoCodeCrcy as IntmdEndingBalAmtInCoCodeCrcy,
...
@Semantics.amount.currencyCode: 'CompanyCodeCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInCoCodeCrcy as GLAcctDebitAmtInCoCodeCrcy,
...
@Semantics.amount.currencyCode: 'CompanyCodeCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInCoCodeCrcy as GLAcctCreditAmtInCoCodeCrcy,
...
@Semantics.amount.currencyCode: 'GlobalCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalanceAmtInGlobalCrcy as IntmdEndingBalAmtInGlobalCrcy,
...
@Semantics.amount.currencyCode: 'GlobalCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInGlobalCrcy as IntmdDebitAmountInGlobalCrcy,
...
@Semantics.amount.currencyCode: 'GlobalCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInGlobalCrcy as IntmdCreditAmountInGlobalCrcy,
...
@AnalyticsDetails.query.formula : '$projection.EndingBalAmtInFreeDfndCrcy1 - $projection.DebitAmountInFreeDfndCrcy1 - CreditAmountInFreeDefinedCrcy1' 
cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_osl_ui ) as StrtgBalAmtInFreeDfndCrcy1,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdDebitAmtInFreeDfndCrcy1' cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_osl ) as DebitAmountInFreeDfndCrcy1,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdCreditAmtInFreeDfndCrcy1' cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_osl ) as CreditAmountInFreeDfndCrcy1,  
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency1'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalAmtInFreeDfndCrcy1 as IntmdEndingBalInFreeDfndCrcy1,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency1'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInFreeDefinedCrcy1 as IntmdDebitAmtInFreeDfndCrcy1,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency1'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInFreeDefinedCrcy1 as IntmdCreditAmtInFreeDfndCrcy1,
...
@AnalyticsDetails.query.formula : '$projection.EndingBalAmtInFreeDfndCrcy2 - $projection.DebitAmountInFreeDfndCrcy2 - CreditAmountInFreeDefinedCrcy2' 
cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_vsl_ui ) as StrtgBalAmtInFreeDfndCrcy2,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdDebitAmtInFreeDfndCrcy2' cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_vsl ) as DebitAmountInFreeDfndCrcy2,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdCreditAmtInFreeDfndCrcy2' cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_vsl ) as CreditAmountInFreeDfndCrcy2,  
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency2'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalAmtInFreeDfndCrcy2 as IntmdEndingBalInFreeDfndCrcy2,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency2'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInFreeDefinedCrcy2 as IntmdDebitAmtInFreeDfndCrcy2,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency2'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInFreeDefinedCrcy2 as IntmdCreditAmtInFreeDfndCrcy2,
...
@AnalyticsDetails.query.formula : '$projection.EndingBalAmtInFreeDfndCrcy3 - $projection.DebitAmountInFreeDfndCrcy3 - CreditAmountInFreeDefinedCrcy3' 
cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_bsl_ui ) as StrtgBalAmtInFreeDfndCrcy3,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdDebitAmtInFreeDfndCrcy3' cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_bsl ) as DebitAmountInFreeDfndCrcy3,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdCreditAmtInFreeDfndCrcy3' cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_bsl ) as CreditAmountInFreeDfndCrcy3,  
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency3'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalAmtInFreeDfndCrcy3 as IntmdEndingBalInFreeDfndCrcy3,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency3'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInFreeDefinedCrcy3 as IntmdDebitAmtInFreeDfndCrcy3,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency3'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInFreeDefinedCrcy3 as IntmdCreditAmtInFreeDfndCrcy3,
...
@AnalyticsDetails.query.formula : '$projection.EndingBalAmtInFreeDfndCrcy4 - $projection.DebitAmountInFreeDfndCrcy4 - CreditAmountInFreeDefinedCrcy4' 
cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_csl ) as StrtgBalAmtInFreeDfndCrcy4,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdDebitAmtInFreeDfndCrcy4' cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_csl ) as DebitAmountInFreeDfndCrcy4,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdCreditAmtInFreeDfndCrcy4' cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_csl ) as CreditAmountInFreeDfndCrcy4,  
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency4'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalAmtInFreeDfndCrcy4 as IntmdEndingBalInFreeDfndCrcy4,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency4'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInFreeDefinedCrcy4 as IntmdDebitAmtInFreeDfndCrcy4,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency4'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInFreeDefinedCrcy4 as IntmdCreditAmtInFreeDfndCrcy4,
...
@AnalyticsDetails.query.formula : '$projection.EndingBalAmtInFreeDfndCrcy5 - $projection.DebitAmountInFreeDfndCrcy5 - CreditAmountInFreeDefinedCrcy5' 
cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_dsl ) as StrtgBalAmtInFreeDfndCrcy5,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdDebitAmtInFreeDfndCrcy5' cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_dsl ) as DebitAmountInFreeDfndCrcy5,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdCreditAmtInFreeDfndCrcy5' cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_dsl ) as CreditAmountInFreeDfndCrcy5,  
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency5'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalAmtInFreeDfndCrcy5 as IntmdEndingBalInFreeDfndCrcy5,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency5'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInFreeDefinedCrcy5 as IntmdDebitAmtInFreeDfndCrcy5,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency5'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInFreeDefinedCrcy5 as IntmdCreditAmtInFreeDfndCrcy5,
...
@AnalyticsDetails.query.formula : '$projection.EndingBalAmtInFreeDfndCrcy6 - $projection.DebitAmountInFreeDfndCrcy6 - CreditAmountInFreeDefinedCrcy6' 
cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_esl ) as StrtgBalAmtInFreeDfndCrcy6,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdDebitAmtInFreeDfndCrcy6' cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_esl ) as DebitAmountInFreeDfndCrcy6,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdCreditAmtInFreeDfndCrcy6' cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_esl ) as CreditAmountInFreeDfndCrcy6,  
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency6'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalAmtInFreeDfndCrcy6 as IntmdEndingBalInFreeDfndCrcy6,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency6'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInFreeDefinedCrcy6 as IntmdDebitAmtInFreeDfndCrcy6,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency6'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInFreeDefinedCrcy6 as IntmdCreditAmtInFreeDfndCrcy6,
...
@AnalyticsDetails.query.formula : '$projection.IntmdDebitAmtInFreeDfndCrcy7' cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_fsl ) as DebitAmountInFreeDfndCrcy7,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdCreditAmtInFreeDfndCrcy7' cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_fsl ) as CreditAmountInFreeDfndCrcy7,  
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency7'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalAmtInFreeDfndCrcy7 as IntmdEndingBalInFreeDfndCrcy7,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency7'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInFreeDefinedCrcy7 as IntmdDebitAmtInFreeDfndCrcy7,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency7'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInFreeDefinedCrcy7 as IntmdCreditAmtInFreeDfndCrcy7,
...
@AnalyticsDetails.query.formula : '$projection.EndingBalAmtInFreeDfndCrcy8 - $projection.DebitAmountInFreeDfndCrcy8 - CreditAmountInFreeDefinedCrcy8' 
cast( cast( 1 as abap.dec(23,2)) as fis_start_bal_gsl ) as StrtgBalAmtInFreeDfndCrcy8,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdDebitAmtInFreeDfndCrcy8' cast( cast( 1 as abap.dec(23,2)) as fis_dr_bal_gsl ) as DebitAmountInFreeDfndCrcy8,  
...
@AnalyticsDetails.query.formula : '$projection.IntmdCreditAmtInFreeDfndCrcy8' cast( cast( 1 as abap.dec(23,2)) as fis_cr_bal_gsl ) as CreditAmountInFreeDfndCrcy8,  
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency8'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalAmtInFreeDfndCrcy8 as IntmdEndingBalInFreeDfndCrcy8,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency8'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInFreeDefinedCrcy8 as IntmdDebitAmtInFreeDfndCrcy8,
...
@Semantics.amount.currencyCode: 'FreeDefinedCurrency8'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInFreeDefinedCrcy8 as IntmdCreditAmtInFreeDfndCrcy8,
...
@Semantics.amount.currencyCode: 'BalanceTransactionCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalanceAmtInBalTransCrcy as IntmdEndingBalInBalTransCrcy,
...
@Semantics.amount.currencyCode: 'BalanceTransactionCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInBalanceTransCrcy as IntmdDebitAmtInBalTransCrcy,
...
@Semantics.amount.currencyCode: 'BalanceTransactionCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInBalanceTransCrcy as IntmdCreditAmtInBalTransCrcy,
...
@Semantics.amount.currencyCode: 'TransactionCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalanceAmtInTransCrcy as IntmdEndingBalanceInTransCrcy,
...
@Semantics.amount.currencyCode: 'TransactionCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInTransCrcy as IntmdDebitAmtInTransCrcy,
...
@Semantics.amount.currencyCode: 'TransactionCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInTransCrcy as IntmdCreditAmountInTransCrcy,


@AnalyticsDetails.query.axis: #FREE
@AnalyticsDetails.query.totals: #SHOW
@Semantics.currencyCode:true
I_GLAcctBalanceCube.FunctionalCurrency,
...
@Semantics.amount.currencyCode: 'FunctionalCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.EndingBalanceAmtInFuncnlCrcy as IntmdEndingBalAmtInFuncnlCrcy,
...
@Semantics.amount.currencyCode: 'FunctionalCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.DebitAmountInFunctionalCrcy as IntmdDebitAmountInFuncnlCrcy,
...
@Semantics.amount.currencyCode: 'FunctionalCurrency'
@Consumption.hidden: true
I_GLAcctBalanceCube.CreditAmountInFunctionalCrcy as IntmdCreditAmountInFuncnlCrcy
