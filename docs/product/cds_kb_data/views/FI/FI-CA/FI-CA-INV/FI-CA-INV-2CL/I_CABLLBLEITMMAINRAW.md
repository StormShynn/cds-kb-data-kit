---
name: I_CABLLBLEITMMAINRAW
description: "This CDS view retrieves the main item data with status Raw of a billable item in Convergent Invoicing. This CDS view provides the data to answer the following business questions: Which data exists for a business transaction or event that can't yet be billed? What net amount is receivable or payable for the business transaction or event? To help you decide which CDS view to use for your purposes, SAP has introduced the annotation ObjectModel.supportedCapabilities that indicates the most appropriate use cases for each CDS view. To find out what use cases are best supported by this CDS view, access the entry of the CDS view in the View Browser app and find the values for this annotation under the Annotation tab. For more information, see Supported Capabilities for CDS Views."
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CABLLBLEITMMAINRAW')/$value
semantic_en: "This CDS view retrieves the main item data with status Raw of a billable item in Convergent Invoicing. This CDS view provides the data to answer the following business questions: Which data exists for a business transaction or event that can't yet be billed? What net amount is receivable or payable for the business transaction or event? To help you decide which CDS view to use for your purposes, SAP has introduced the annotation ObjectModel.supportedCapabilities that indicates the most appropriate use cases for each CDS view. To find out what use cases are best supported by this CDS view, access the entry of the CDS view in the View Browser app and find the values for this annotation under the Annotation tab. For more information, see Supported Capabilities for CDS Views."
semantic_vi: "Billable Item Main Data Raw — CDS view giao diện (transactional data) dựa trên Billable Item Main Data Raw."
keywords:
  - "Billable Item Main Data Raw"
  - "billable"
  - "item"
  - "main"
  - "data"
...
tags:
  ...
  - transaction
---
# I_CABLLBLEITMMAINRAW

**This CDS view retrieves the main item data with status Raw of a billable item in Convergent Invoicing. This CDS view provides the data to answer the following business questions: Which data exists for a business transaction or event that can't yet be billed? What net amount is receivable or payable for the business transaction or event? To help you decide which CDS view to use for your purposes, SAP has introduced the annotation ObjectModel.supportedCapabilities that indicates the most appropriate use cases for each CDS view. To find out what use cases are best supported by this CDS view, access the entry of the CDS view in the View Browser app and find the values for this annotation under the Annotation tab. For more information, see Supported Capabilities for CDS Views.**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CABLLBLEITMMAINRAW')/$value) |
...
| `_Extension` | `E_CABllbleItmMainRaw` | [0..1] |

## Source Code

*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CABLLBLEITMMAINRAW')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CABLLBLEITMMAINRAW')/$value)*
...
@ObjectModel: {
  ...
  sapObjectNodeType.name: 'CABllbleItmMainRaw',
...
@EndUserText.label: 'Billable Item Main Data Raw'
define view entity I_CABllbleItmMainRaw
  as select from /1fe/00sap0it as _0SAP0IT
...
//  association [0..1] to I_WBSElement                  as _WBSElement                    on  $projection.WBSElement = _WBSElement.WBSElement
  ...
  // extension
  association [0..1] to E_CABllbleItmMainRaw          as _Extension                     on  $projection.CABllbleItmPackNo          = _Extension.CABllbleItmPackNo
