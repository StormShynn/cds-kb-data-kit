...
semantic_vi: "Bllble Itm Main Data Billable Excepted — CDS view giao diện (transactional data) dựa trên Bllble Itm Main Data Billable Excepted."
keywords:
...
| `_Extension` | `E_CABllbleItmMainBllbleExcptd` | [0..1] |
...
@ObjectModel: {
  ...
  sapObjectNodeType.name: 'CABllbleItmMainBllbleExcptd',
...
@EndUserText.label: 'Bllble Itm Main Data Billable Excepted'
define view entity I_CABllbleItmMainBllbleExcptd
  as select from /1fe/00sap3it as _0SAP3IT
  ...
  // extension
  association [0..1] to E_CABllbleItmMainBllbleExcptd as _Extension                     on  $projection.CABllbleItmPackNo          = _Extension.CABllbleItmPackNo
