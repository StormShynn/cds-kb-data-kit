...
semantic_vi: "View I_BR_NFEDOCUMENTSTATUS hiển thị trạng thái của tài liệu NFe Brazil, có thể được sử dụng để theo dõi trạng thái xử lý của tài liệu này trong thành phần FI-LOC-LO-BR."
keywords:
  - "nfe document"
  - "tài liệu nfe"
  - "document status"
