...
semantic_vi: "View I_BR_NFREFERENCEDPROCORIGN hiển thị dữ liệu kinh doanh liên quan đến nguồn gốc của các quy trình tham chiếu trong hệ thống BR, có ích khi phân tích hoặc khắc phục các luồng quy trình trong thành phần FI-LOC-LO-BR."
keywords:
  - "br system"
  - "fi-loc-lo-br"
  - "referenced process"
...
semantic_en: "The I_BR_NFREFERENCEDPROCORIGN view exposes business data related to the origin of referenced processes in the BR system, which is useful when analyzing or troubleshooting process flows in the FI-LOC-LO-BR component."
