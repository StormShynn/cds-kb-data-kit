---
name: I_EWM_WHSEORDERCTNRULETEXT_2
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_EWM_WHSEORDERCTNRULETEXT_2')/$value
...
semantic_vi: "Warehouse Order Creation Rule - Text — CDS view giao diện dựa trên Warehouse Order Creation Rule - Text."
keywords:
  - "warehouse"
  - "order"
  - "creation"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_EWM_WHSEORDERCTNRULETEXT_2')/$value) |
...
| `WarehouseOrderCreationRuleName` |  | |  | `text` | `CHAR(40)` | Description |
| `_Warehouse` | | ✓ | | | | |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_EWM_WHSEORDERCTNRULETEXT_2')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_EWM_WHSEORDERCTNRULETEXT_2')/$value)*

```abap
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Warehouse Order Creation Rule - Text'

@VDM.viewType: #BASIC

@ObjectModel.representativeKey: 'WarehouseOrderCreationRule'
@ObjectModel.dataCategory: #TEXT
@Analytics.technicalName: 'IEWMWOCTNRULET2'
...
define view entity I_EWM_WhseOrderCtnRuleText_2
  as select from /scwm/twcrt as WhseOrderCtnRuleText
  association [0..1] to I_EWM_WarehouseNumber_2 as _Warehouse on $projection.EWMWarehouse = _Warehouse.EWMWarehouse
{
  ...
  key wcr   as WarehouseOrderCreationRule,
      ...
      @Search.ranking: #HIGH
      text  as WarehouseOrderCreationRuleName,
      _Warehouse
}
```
