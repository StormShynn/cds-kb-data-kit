...
semantic_vi: "Storage Bin Activity Area Lean - Query — CDS view tiêu dùng dựa trên I_EWM_StorageBinActyAreaCube."
keywords:
  - "storage"
  - "bin"
  - "activity"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_EWM_STORBINACTYAREALEANQ')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_EWM_STORBINACTYAREALEANQ')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_EWM_STORBINACTYAREALEANQ')/$value)*
...
@EndUserText.label: 'Storage Bin Activity Area Lean - Query'
@VDM.viewType:#CONSUMPTION
@OData.publish:            true
@Analytics.query:              true
@Analytics.technicalName: 'CEWMSTOBAALQ'
define view entity C_EWM_StorBinActyAreaLeanQ
  with parameters
