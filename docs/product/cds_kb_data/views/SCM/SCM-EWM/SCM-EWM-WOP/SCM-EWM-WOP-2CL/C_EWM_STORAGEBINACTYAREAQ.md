...
semantic_vi: "Storage Bin Activity Area - Query — CDS view tiêu dùng dựa trên I_EWM_StorageBinActyAreaCube."
keywords:
  - "storage"
  - "bin"
  - "activity"
...
tags:
  ...
  - SCM-EWM-WOP-2CL
---
# C_EWM_STORAGEBINACTYAREAQ

**Storage Bin Activity Area - Query**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_EWM_STORAGEBINACTYAREAQ')/$value) |
...
| `ActivityAreaName` |  | |  | `cast(_ActivityArea._Text[1:Language = $parameters.P_Language].ActivityAreaName as ewm_de_activityareadesc preserving type)` | `CHAR(40)` | Activity Area Description |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_EWM_STORAGEBINACTYAREAQ')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_EWM_STORAGEBINACTYAREAQ')/$value)*
...
@EndUserText.label: 'Storage Bin Activity Area - Query'
@VDM.viewType:#CONSUMPTION
@OData.publish:            true
@Analytics.query:              true
@Analytics.technicalName: 'CEWMSTOBAAQ'
define view entity C_EWM_StorageBinActyAreaQ
  with parameters
  ...
  as select from I_EWM_StorageBinActyAreaCube( P_DisplayWeightUnit :  $parameters.P_DisplayWeightUnit, P_DisplayVolumeUnit : $parameters.P_DisplayVolumeUnit )
{
      // Keys
  ...
  key EWMStorageBin,
      ...
      cast(_ActivityArea._Text[1:Language = $parameters.P_Language].ActivityAreaName as ewm_de_activityareadesc preserving type)         as ActivityAreaName,
