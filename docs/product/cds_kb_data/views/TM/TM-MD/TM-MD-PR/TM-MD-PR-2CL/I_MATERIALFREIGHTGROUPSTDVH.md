---
name: I_MATERIALFREIGHTGROUPSTDVH
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MATERIALFREIGHTGROUPSTDVH')/$value
semantic_en: "Material Freight Group"
semantic_vi: "Material Freight Group — CDS view tổng hợp dựa trên I_MaterialFreightGroup."
keywords:
  - "material"
  - "freight"
  - "group"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MATERIALFREIGHTGROUPSTDVH')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MATERIALFREIGHTGROUPSTDVH')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MATERIALFREIGHTGROUPSTDVH')/$value)*
...
define view entity I_MaterialFreightGroupStdVH 
