...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MAINTEQUIPHIERARCHYNODE')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MAINTEQUIPHIERARCHYNODE')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MAINTEQUIPHIERARCHYNODE')/$value)*
...
@Analytics: {
  ...
  dataExtraction.delta.changeDataCapture.mapping: [{
    role: #MAIN,
    table: 'EQUZ',
    viewElement: ['HierarchyNode', 'EquipUsagePeriodSequenceNumber', 'ValidityEndDate'],--, 'Equipment', 'SuperordinateEquipment', 'ValidityStartDate'],
    tableElement: ['EQUNR', 'EQLFN', 'DATBI']--, 'EQUNR', 'HEQUI', 'DATAB']
  }]
}
...
define view entity I_MaintEquipHierarchyNode
