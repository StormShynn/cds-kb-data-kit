...
semantic_vi: "Customer Listed Substance Extraction — CDS view tiêu dùng dựa trên I_ListedSubstanceCust."
keywords:
  - "customer"
  - "listed"
  - "substance"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_LISTEDSUBSTANCECUSTDEX')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_LISTEDSUBSTANCECUSTDEX')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_LISTEDSUBSTANCECUSTDEX')/$value)*

```abap
@AbapCatalog.viewEnhancementCategory: [#NONE]
@AccessControl.authorizationCheck: #MANDATORY
@EndUserText.label: 'Customer Listed Substance Extraction'
...
define view entity C_ListedSubstanceCustDEX
  as select from I_ListedSubstanceCust
{
  key ListedSubstance,
      @Semantics.uuid: true
