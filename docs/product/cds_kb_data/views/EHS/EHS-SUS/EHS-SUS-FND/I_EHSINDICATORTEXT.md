...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_EHSINDICATORTEXT')/$value) |
...
| `IndicatorText` |  | |  |  | `CHAR(60)` | Short Text for Fixed Values |
