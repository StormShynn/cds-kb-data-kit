...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_TRDCLASSFCTNNMBRSCHMTYPETEXT')/$value) |
...
| `TrdClassfctnNmbrSchmType` |  | |  |  | `CHAR(10)` | Values for Domains: Single Value/Lower Limit |
| `TrdClassfctnNmbrSchmTypeName` |  | |  |  | `CHAR(60)` | Short Text for Fixed Values |
