...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_PRAPAYTRECORDTYPETEXT')/$value) |
...
| `RecordTypeName` |  | |  |  | `CHAR(60)` | Payment Record Type Name |
