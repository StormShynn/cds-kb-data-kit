...
semantic_vi: "PRA Tax Rptg Hist Wyoming Consvn Qry — CDS view tiêu dùng dựa trên I_PRATaxRptgHistWYConsvn."
keywords:
  - "pra"
  - "tax"
  - "rptg"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_PRATAXRPTGHISTWYCONSVNQRY')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_PRATAXRPTGHISTWYCONSVNQRY')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_PRATAXRPTGHISTWYCONSVNQRY')/$value)*

```abap
@EndUserText.label: 'PRA Tax Rptg Hist Wyoming Consvn Qry'
@Analytics.query:true
@VDM.viewType: #CONSUMPTION
@AccessControl.authorizationCheck:#PRIVILEGED_ONLY
@AbapCatalog.sqlViewName: 'CPVTAXRPTGHWYC'
//@OData.publish: true
...
define view C_PRATaxRptgHistWYConsvnQry
  as select from I_PRATaxRptgHistWYConsvn
{
