---
name: I_CONTRALLOCVOLPRIMPROD
description: "CA Volume for Primary Products"
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CONTRALLOCVOLPRIMPROD')/$value
semantic_en: "CA Volume for Primary Products"
semantic_vi: "CA Volume for Primary Products — CDS view giao diện dựa trên P_ContrAllocVolPrimProd."
keywords:
  - "volume"
  - "for"
  - "primary"
...
tags:
  ...
  - product
---
# I_CONTRALLOCVOLPRIMPROD

**CA Volume for Primary Products**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CONTRALLOCVOLPRIMPROD')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CONTRALLOCVOLPRIMPROD')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_CONTRALLOCVOLPRIMPROD')/$value)*

```abap
@EndUserText.label: 'CA Volume for Primary Products'
@Analytics.dataCategory: #CUBE
@Metadata.allowExtensions:true
@Metadata.ignorePropagatedAnnotations:true
@Analytics.dataExtraction.enabled: true
@VDM.viewType: #COMPOSITE
@AbapCatalog.sqlViewName: 'IPVCAVOLPRIM'
...
@ObjectModel.sapObjectNodeType.name: 'PRAContrAllocVolPrimProd'

define view I_ContrAllocVolPrimProd
  as select from P_ContrAllocVolPrimProd
...

{
  ...
  key Transporter,
      ...
      //Numeric attributes (change later to no aggregation when supported)
