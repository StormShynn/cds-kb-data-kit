...
semantic_vi: "Tax Classification — CDS view giao diện dựa trên oiu_cm_taxcls."
keywords:
  - "tax"
  - "classification"
  - "country"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_TAXCLASSIFICATION')/$value) |
...
| `_Text` | `I_TaxClassificationText` | [0..*] |

## Source Code

*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_TAXCLASSIFICATION')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_TAXCLASSIFICATION')/$value)*
...
@VDM.viewType: #BASIC
@AbapCatalog.sqlViewName: 'IPVTAXCLASS'
...
@ObjectModel.sapObjectNodeType.name: 'PRATaxClassification'

define view I_TaxClassification
  as select from oiu_cm_taxcls
  ...
  association [0..*] to I_TaxClassificationText as _Text                  on  $projection.Country               = _Text.Country
                                                                          and $projection.PrimaryGeogrlLocation = _Text.PrimaryGeogrlLocation
                                                                          and $projection.TaxClassification     = _Text.TaxClassification
{
