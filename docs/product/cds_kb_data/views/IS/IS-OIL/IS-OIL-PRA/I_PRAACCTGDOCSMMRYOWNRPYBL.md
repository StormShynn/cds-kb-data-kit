...
semantic_vi: "PRA Acctg Document Summary Owner Payable — CDS view giao diện dựa trên PRA Acctg Document Summary Owner Payable."
keywords:
  - "pra"
  - "acctg"
  - "document"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_PRAACCTGDOCSMMRYOWNRPYBL')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_PRAACCTGDOCSMMRYOWNRPYBL')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_PRAACCTGDOCSMMRYOWNRPYBL')/$value)*

```abap
@EndUserText.label: 'PRA Acctg Document Summary Owner Payable'
@Analytics.dataCategory: #CUBE
@Metadata.allowExtensions:true
@Metadata.ignorePropagatedAnnotations:true
@Analytics.dataExtraction.enabled: true
@VDM.viewType: #BASIC
@AbapCatalog.sqlViewName: 'IPVSMMRYOWNRPYBL'
...
@ObjectModel.sapObjectNodeType.name: 'PRAAcctgDocSmmryOwnrPybl'
define view I_PRAAcctgDocSmmryOwnrPybl
  as select from /pra/pp_pay_sum
...
//    add fiscal period association later when accp join is enabled      
