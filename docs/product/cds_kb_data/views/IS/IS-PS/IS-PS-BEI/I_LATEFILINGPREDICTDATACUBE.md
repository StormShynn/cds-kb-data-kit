...
semantic_vi: "Apply dataset for Late Filing - Cube — CDS view giao diện dựa trên P_TF_LATE_FILING."
keywords:
  - "apply"
  - "dataset"
  - "for"
...
tags:
  ...
  - IS-PS-BEI
---
# I_LATEFILINGPREDICTDATACUBE

**Apply dataset for Late Filing - Cube**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_LATEFILINGPREDICTDATACUBE')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_LATEFILINGPREDICTDATACUBE')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_LATEFILINGPREDICTDATACUBE')/$value)*

```abap
@AbapCatalog.sqlViewName: 'ILTFILGPREDICTC'
...
@EndUserText.label: 'Apply dataset for Late Filing - Cube'
define view I_LateFilingPredictDataCube
  as select from P_TF_LATE_FILING(P_SAPClient : $session.client , P_DatasetType : 'P', P_BalanceFlag : 'X')
{
  ...
  key BhvrlInsgtsCalDate,
      ...
      NrOfObjection3Month,
      @EndUserText.label: 'Interest Documents (past 3 mos)'
      NrOfInterestDocument3Month,
      @EndUserText.label: 'Interest Documents (past 6 mos)'
      NrOfInterestDocument6Month,
      @EndUserText.label: 'Interest Documents (past 12 mos)'
      NrOfInterestDocument12Month,
      @EndUserText.label: 'Clearing Documents (past 3 mos)'
      NrOfNoClearingDocument3Month,
      @EndUserText.label: 'Clearing Documents (past 6 mos)'
      NrOfNoClearingDocument6Month,
      @EndUserText.label: 'Clearing Documents (past 12 mos)'
      ...
      @EndUserText.label: 'Months since on-time filer'
      NrOfMonthSinceFiler,
