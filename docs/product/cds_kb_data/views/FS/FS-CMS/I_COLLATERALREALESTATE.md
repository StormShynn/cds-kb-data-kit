...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_COLLATERALREALESTATE')/$value
semantic_en: "Collateral Real Estate Object Details"
semantic_vi: "Collateral Real Estate Object Details — CDS view giao diện dựa trên P_RealEstateObject_TF."
keywords:
  - "collateral"
  - "real"
  - "estate"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_COLLATERALREALESTATE')/$value) |
...
| `ColltrlRealEstateConvertedID` |  | |  | `obj_guid_conv` | `CHAR(40)` | Reference ID for the object |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_COLLATERALREALESTATE')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_COLLATERALREALESTATE')/$value)*

```abap
@AbapCatalog: {
    sqlViewName: 'ICOLREALESTATE',
...
@Analytics:{
    ...
    delta.changeDataCapture: {
        mapping: [ {
           table : 'CMS_RE_OBJ',
           role : #MAIN,
           viewElement : ['CollateralRealEstateUUID'],
...
define view I_CollateralRealEstate
  as select from P_RealEstateObject_TF(P_SAPClient: $session.client)
  ...
  association [0..*] to I_ObjectAssetData              as _ObjectAssetData              on  $projection.ColltrlRealEstateConvertedID = _ObjectAssetData.ObjectAssetReferenceNumber
  ...
  association [0..1] to I_UnitOfMeasure                as _CollateralRealEstateVolUnit  on  $projection.CollateralRealEstateVolumeUnit = _CollateralRealEstateVolUnit.UnitOfMeasure
{
  key obj_guid        as CollateralRealEstateUUID,
      obj_guid_conv   as ColltrlRealEstateConvertedID,
