...
semantic_vi: "Rights Object Details — CDS view giao diện dựa trên cms_rig."
keywords:
  - "rights"
  - "object"
  - "details"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_RIGHTSOBJECTMASTERDATA')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_RIGHTSOBJECTMASTERDATA')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_RIGHTSOBJECTMASTERDATA')/$value)*

```abap
@AbapCatalog: {
    sqlViewName: 'IRIGOBJMDATA',
...
define view I_RightsObjectMasterData
  as select from cms_rig
  association [0..1] to I_RightsObjectData             as _RightsObjectData             on  $projection.RightsObjectUUID = _RightsObjectData.RightsObjectUUID
