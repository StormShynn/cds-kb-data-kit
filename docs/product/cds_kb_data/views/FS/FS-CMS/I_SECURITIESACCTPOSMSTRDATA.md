...
semantic_vi: "Securities Account Position Details — CDS view giao diện dựa trên cms_sec_acc_pos."
keywords:
  - "securities"
  - "account"
  - "position"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SECURITIESACCTPOSMSTRDATA')/$value) |
...
|---|---|---|
| `_SecuritiesAccountPosition` | `I_SecuritiesAccountPosition` | [0..1] |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SECURITIESACCTPOSMSTRDATA')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_SECURITIESACCTPOSMSTRDATA')/$value)*

```abap
@AbapCatalog: {
    sqlViewName: 'ISECACCPOSMD',
...
define view I_SecuritiesAcctPosMstrData
  as select from cms_sec_acc_pos
  association [0..1] to I_SecuritiesAccountPosition    as _SecuritiesAccountPosition     on $projection.SecuritiesAccountPositionUUID = _SecuritiesAccountPosition.SecuritiesAccountPositionUUID
