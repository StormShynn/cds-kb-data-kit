...
semantic_vi: "Movable Object Details — CDS view giao diện dựa trên cms_movables."
keywords:
  - "movable"
  - "object"
  - "details"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MOVABLEOBJECTMASTERDATA')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MOVABLEOBJECTMASTERDATA')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MOVABLEOBJECTMASTERDATA')/$value)*

```abap
@AbapCatalog: {
    sqlViewName: 'IMOVOBJMDATA',
...
define view I_MovableObjectMasterData
  as select from cms_movables
  association [0..1] to I_MovableObjectData            as _MovableObjectData             on  $projection.MovableObjectUUID = _MovableObjectData.MovableObjectUUID
