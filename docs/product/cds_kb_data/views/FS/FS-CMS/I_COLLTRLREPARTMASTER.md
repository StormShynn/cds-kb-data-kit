...
semantic_vi: "Part Details for Collateral Real Estate — CDS view giao diện dựa trên cms_re_obj_prt."
keywords:
  - "part"
  - "details"
  - "for"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_COLLTRLREPARTMASTER')/$value) |
...
| `_ColltrlREUsageType` | | ✓ | | | | |
| `_ColltrlREUsageType1` | | ✓ | | | | |
| `_ColltrlREUsageType2` | | ✓ | | | | |
...
| `_ColltrlREUsageType1` | `I_ColltrlREUsageType` | [0..1] |
| `_ColltrlREUsageType2` | `I_ColltrlREUsageType` | [0..1] |
...
| `_ColltrlREDailyAvgPrcCurrency` | `I_Currency` | [0..1] |
...
| `_ColltrlREPartCondition` | `I_CollateralAttributeIndType` | [0..1] |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_COLLTRLREPARTMASTER')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_COLLTRLREPARTMASTER')/$value)*

```abap
@AbapCatalog: {
    sqlViewName: 'ICREPARTMASTER',
...
define view I_ColltrlREPartMaster
  as select from cms_re_obj_prt
  ...
  association [0..1] to I_ColltrlREUsageType           as _ColltrlREUsageType            on  $projection.ColltrlREMainUsageType = _ColltrlREUsageType.CollateralRealEstateUsageType
  association [0..1] to I_ColltrlREUsageType           as _ColltrlREUsageType1           on  $projection.ColltrlREAdditionalUsageType1 = _ColltrlREUsageType1.CollateralRealEstateUsageType
  association [0..1] to I_ColltrlREUsageType           as _ColltrlREUsageType2           on  $projection.ColltrlREAdditionalUsageType2 = _ColltrlREUsageType2.CollateralRealEstateUsageType
  ...
  association [0..1] to I_Currency                     as _ColltrlREDailyAvgPrcCurrency  on  $projection.ColltrlREDailyAvgPriceCurrency = _ColltrlREDailyAvgPrcCurrency.Currency
  ...
  association [0..1] to I_CollateralAttributeIndType   as _ColltrlREPartCondition        on  $projection.ColltrlRealEstatePartCondition        = _ColltrlREPartCondition.CollateralAttributeIndType
                                                                                         and _ColltrlREPartCondition.CollateralAttributeIndCat = 'REO001'
                                                                                         ...
                                                                                         and _ColltrlREInsuranceType.CollateralAttributeIndCat = 'REO011'
{
  key obj_prt_guid     as CollateralRealEstatePartUUID,
      ...
      @ObjectModel.foreignKey.association: '_ColltrlREPartCondition'
      ...
      @ObjectModel.foreignKey.association: '_ColltrlREUsageType1'
      add_usage_1      as ColltrlREAdditionalUsageType1,
      @ObjectModel.foreignKey.association: '_ColltrlREUsageType2'
      ...
      @Semantics.currencyCode: true
      @ObjectModel.foreignKey.association: '_ColltrlREDailyAvgPrcCurrency'
