...
semantic_vi: "MDQ Score for Product Dimensions - Query — CDS view tiêu dùng dựa trên MDQ Score for Product Dimensions - Query."
keywords:
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRPRODDIMNQRY')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRPRODDIMNQRY')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRPRODDIMNQRY')/$value)*

```abap
@AccessControl.authorizationCheck: #NOT_ALLOWED
@Analytics.internalName: #LOCAL
@EndUserText.label: 'MDQ Score for Product Dimensions - Query'
...
define transient view entity C_MDQAnlytsScrProdDimnQry
  provider contract analytical_query
  as projection on I_MDQAnlytsScrProdDimnCube as _MDQAnlytsScrProdDimnCube
{
  //dimension data
  //instead of long text SAC/RSRT uses medium text
  @EndUserText.label: 'Alternative Unit of Measure'
  AlternativeUnit,
