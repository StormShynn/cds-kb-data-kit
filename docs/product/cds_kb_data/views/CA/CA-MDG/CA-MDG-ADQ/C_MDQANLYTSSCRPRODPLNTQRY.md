---
name: C_MDQANLYTSSCRPRODPLNTQRY
description: "MDQ Score for Product Plant - Query"
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRPRODPLNTQRY')/$value
semantic_en: "MDQ Score for Product Plant - Query"
semantic_vi: "MDQ Score for Product Plant - Query — CDS view tiêu dùng dựa trên MDQ Score for Product Plant - Query."
keywords:
  - "MDQ Score for Product Plant"
  - "mdq"
  - "score"
  - "for"
  - "product"
...
tags:
  ...
  - product
---
# C_MDQANLYTSSCRPRODPLNTQRY

**MDQ Score for Product Plant - Query**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRPRODPLNTQRY')/$value) |
...
| `CostingSpecialProcurementType` |  | |  |  | `CHAR(2)` | Special Procurement Type for Costing |
| `CountryOfOrigin` |  | |  |  | `CHAR(3)` | Country/Region of Origin of Product |
| `DependentRequirementsType` |  | |  |  | `CHAR(1)` | Indicator for Individual and Collective Requirements |
| `IsAutoPurOrdCreationAllowed` |  | |  |  | `CHAR(1)` | Indicator: "automatic purchase order allowed" |
| `LoadingGroup` |  | |  |  | `CHAR(4)` | Loading Group |
| `LotSizingProcedure` |  | |  |  | `CHAR(2)` | Lot Sizing Procedure in Materials Planning |
| `MRPAvailabilityType` |  | |  |  | `CHAR(1)` | Mixed MRP indicator |
| `MRPGroup` |  | |  |  | `CHAR(4)` | MRP Group |
| `MRPPlanningCalendar` |  | |  |  | `CHAR(3)` | Planning Calendar |
| `MRPResponsible` |  | |  |  | `CHAR(3)` | MRP Controller |
| `MRPType` |  | |  |  | `CHAR(2)` | MRP Type |
| `PlanningStrategyGroup` |  | |  |  | `CHAR(2)` | Planning Strategy Group |
| `Plant` |  | |  |  | `CHAR(4)` | Plant |
| `ProcurementSubType` |  | |  |  | `CHAR(2)` | Special Procurement Type |
| `ProcurementType` |  | |  |  | `CHAR(1)` | Procurement Type |
| `ProductionSupervisor` |  | |  |  | `CHAR(3)` | Production Supervisor |
| `PurchasingGroup` |  | |  |  | `CHAR(3)` | Purchasing Group |
| `QualityMgmtCtrlKey` |  | |  |  | `CHAR(8)` | Control Key for Quality Management in Procurement |
| `RegionOfOrigin` |  | |  |  | `CHAR(3)` | Region of Origin |
| `RoundingProfile` |  | |  |  | `CHAR(4)` | Rounding Profile |
| `SchedulingFloatProfile` |  | |  |  | `CHAR(3)` | Scheduling Profile for Floats |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRPRODPLNTQRY')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRPRODPLNTQRY')/$value)*

```abap
@AccessControl.authorizationCheck: #NOT_ALLOWED
@Analytics.internalName: #LOCAL
@EndUserText.label: 'MDQ Score for Product Plant - Query'
...
define transient view entity C_MDQAnlytsScrProdPlntQry
  provider contract analytical_query
  as projection on I_MDQAnlytsScrProdPlntCube as _MDQAnlytsScrProdPlntCube
{
//  //plant data
  ABCIndicator,
