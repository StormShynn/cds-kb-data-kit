...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRSUPLRPURQ')/$value
semantic_en: "This CDS view helps to retrieve the results of quality evaluations and master data scores for supplier purchasing data. You can analyze the data using master data attributes, for example, country or purchasing organization, to identify any issues and improve the data. This CDS view provides the data to answer the following business questions: What is the quality score of my supplier purchasing data? Which data is compliant with or violating specific validation rules? To help you decide which CDS view to use for your purposes, SAP has introduced the annotation ObjectModel.supportedCapabilities that indicates the most appropriate use cases for each CDS view. To find out what use cases are best supported by this CDS view, access the entry of the CDS view in the View Browser app and find the values for this annotation under the Annotation tab. For more information, see Supported Capabilities for CDS Views."
semantic_vi: "MDQ Score Supplier Purchase - Query — CDS view tiêu dùng dựa trên MDQ Score Supplier Purchase - Query."
keywords:
  - "MDQ Score Supplier Purchase"
  - "mdq"
  - "score"
  - "supplier"
  - "purchase"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRSUPLRPURQ')/$value) |
...
| `PurchaseOrderCurrency` |  | |  |  | `CUKY(5)` | Purchase order currency |
| `PurchasingGroup` |  | |  |  | `CHAR(3)` | Purchasing Group |
| `PurchasingIsBlockedForSupplier` |  | |  |  | `CHAR(1)` | Purchasing block at purchasing organization level |
| `PurchasingOrganization` |  | |  |  | `CHAR(4)` | Purchasing Organization |
| `RoundingProfile` |  | |  |  | `CHAR(4)` | Rounding Profile |
| `PlanningCycle` |  | |  |  | `CHAR(3)` | Planning Cycle |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRSUPLRPURQ')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRSUPLRPURQ')/$value)*

```abap
@AccessControl.authorizationCheck: #NOT_ALLOWED
@AccessControl.personalData.blocking: #REQUIRED
@Analytics.internalName: #LOCAL
@EndUserText.label: 'MDQ Score Supplier Purchase - Query'
...
define transient view entity C_MDQAnlytsScrSuplrPurQ
  provider contract analytical_query
  as projection on I_MDQAnlytsScrSuplrPurC as _MDQAnlytsScrSuplrPurC
{
  //process data
