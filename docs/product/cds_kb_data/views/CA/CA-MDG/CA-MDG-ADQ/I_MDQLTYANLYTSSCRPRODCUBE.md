...
description: "MDQ Score for Product - Cube"
...
semantic_en: "MDQ Score for Product - Cube"
semantic_vi: "MDQ Score for Product - Cube — CDS view giao diện dựa trên I_MDQltyAnlytsScrProd."
keywords:
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MDQLTYANLYTSSCRPRODCUBE')/$value) |
...
| `MDQltyProdAlPgNavgnPath` |  | |  | `cast( concat( _FLPHostPath.MDQltyFioriLaunchpadHostPath, '#MDQualityEvaluation-displayEvaluationResultProdGen?MDQltyBusRuleEvalResultCode=F&MDQltyBusinessObjectTypeCode=194') as mdq_maint_host_path )` | `SSTR(1333)` | Fiori Host Path concatenated with Navigation Target |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MDQLTYANLYTSSCRPRODCUBE')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MDQLTYANLYTSSCRPRODCUBE')/$value)*
...
@EndUserText.label: 'MDQ Score for Product - Cube'
@Metadata.allowExtensions: true
@Metadata.ignorePropagatedAnnotations: true
@ObjectModel.modelingPattern: #ANALYTICAL_CUBE
@ObjectModel.sapObjectNodeType.name: 'MDQProductEvalAnalyticalScore'
...
define view entity I_MDQltyAnlytsScrProdCube
  as select from I_MDQltyAnlytsScrProd
  ...
  association [0..1] to E_Product                      as _ProductExtension             on  _ProductExtension.Product = $projection.Product
{
  ...
  key MDQltyBusRuleEvalResultCode,
      ...
      cast( concat( _FLPHostPath.MDQltyFioriLaunchpadHostPath,
        '#MDQualityEvaluation-displayEvaluationResultProdGen?MDQltyBusRuleEvalResultCode=F&MDQltyBusinessObjectTypeCode=194') as mdq_maint_host_path ) as MDQltyProdAlPgNavgnPath
}
```
