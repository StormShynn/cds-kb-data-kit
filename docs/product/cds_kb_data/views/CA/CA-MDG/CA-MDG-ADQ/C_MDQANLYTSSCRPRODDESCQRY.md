---
name: C_MDQANLYTSSCRPRODDESCQRY
description: "MDQ Score for Product Description - Qry"
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRPRODDESCQRY')/$value
semantic_en: "MDQ Score for Product Description - Qry"
semantic_vi: "MDQ Score for Product Description - Qry — CDS view tiêu dùng dựa trên MDQ Score for Product Description - Qry."
keywords:
  - "mdq"
  - "score"
  - "for"
...
tags:
  ...
  - product
---
# C_MDQANLYTSSCRPRODDESCQRY

**MDQ Score for Product Description - Qry**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRPRODDESCQRY')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRPRODDESCQRY')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_MDQANLYTSSCRPRODDESCQRY')/$value)*

```abap
@AccessControl.authorizationCheck: #NOT_ALLOWED
@Analytics.internalName: #LOCAL
@EndUserText.label: 'MDQ Score for Product Description - Qry'
...
define transient view entity C_MDQAnlytsScrProdDescQry
  provider contract analytical_query
  as projection on I_MDQAnlytsScrProdDescCube
{
  //description data
  Language,
  ProductDescription,
