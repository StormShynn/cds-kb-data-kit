...
semantic_vi: "View I_ADDITIONALMATERIALGROUP2TEXT hiển thị tên nhóm vật liệu bổ sung 2 trong các ngôn ngữ khác nhau, có thể được sử dụng để hiển thị thông tin nhóm vật liệu trong các ứng dụng đa ngôn ngữ."
keywords:
  ...
  - "text view"
  - "interface view"
semantic_en: "The I_ADDITIONALMATERIALGROUP2TEXT view exposes additional material group 2 names in different languages, which can be used to display material group information in multilingual applications."
