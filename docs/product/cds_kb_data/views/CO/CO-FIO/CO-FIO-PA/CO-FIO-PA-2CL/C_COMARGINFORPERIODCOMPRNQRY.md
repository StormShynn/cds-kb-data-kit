...
semantic_vi: "Company Margin Comparison Query Template — CDS view tiêu dùng dựa trên Company Margin Comparison Query Template."
keywords:
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_COMARGINFORPERIODCOMPRNQRY')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_COMARGINFORPERIODCOMPRNQRY')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_COMARGINFORPERIODCOMPRNQRY')/$value)*
...
@EndUserText.label: 'Company Margin Comparison Query Template'
define transient view entity C_CoMarginForPeriodComprnQry
