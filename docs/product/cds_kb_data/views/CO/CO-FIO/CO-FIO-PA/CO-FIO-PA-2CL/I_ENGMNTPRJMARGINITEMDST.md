---
name: I_ENGMNTPRJMARGINITEMDST
description: "DSt for EngmntPrjMarginItem"
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENGMNTPRJMARGINITEMDST')/$value
semantic_en: "DSt for EngmntPrjMarginItem"
semantic_vi: "DSt for EngmntPrjMarginItem — CDS view giao diện dựa trên ienprjitmdsttab."
keywords:
  - "dst"
  - "for"
  - "engmntprjmarginitem"
...
tags:
  ...
  - lob:finance
---
# I_ENGMNTPRJMARGINITEMDST

**DSt for EngmntPrjMarginItem**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENGMNTPRJMARGINITEMDST')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENGMNTPRJMARGINITEMDST')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENGMNTPRJMARGINITEMDST')/$value)*

```abap
@AccessControl.authorizationCheck: #PRIVILEGED_ONLY
@EndUserText.label: 'DSt for EngmntPrjMarginItem'
@VDM.viewType: #BASIC
...
@Analytics.document.storageForEntity: [ 'I_ENGMNTPRJMARGINITEMCUBE' ]
@Analytics.document.serviceClassName: 'CL_CELL_COMMENT_GENERIC_HDLR'
@ObjectModel.usageType.sizeCategory: #XXL
@ObjectModel.usageType.serviceQuality: #D
@ObjectModel.usageType.dataClass: #MIXED
@Metadata.ignorePropagatedAnnotations:true
define view entity I_EngmntPrjMarginItemDSt
  as select from ienprjitmdsttab
{
  @Analytics.document: {
    type: #DOC, 
    semantics: #ID
