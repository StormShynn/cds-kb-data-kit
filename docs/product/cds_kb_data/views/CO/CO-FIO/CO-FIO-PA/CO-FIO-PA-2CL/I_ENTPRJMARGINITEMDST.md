---
name: I_ENTPRJMARGINITEMDST
description: "Document for EntPrjMarginItem"
app_component: CO-FIO-PA-2CL
software_component: SAPSCORE
release_state: released
system_type: S/4HANA Cloud Public Edition
source_available: true
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENTPRJMARGINITEMDST')/$value
semantic_en: "Document for EntPrjMarginItem"
semantic_vi: "Document for EntPrjMarginItem — CDS view giao diện dựa trên ientprjmadsttab."
keywords:
  - "document"
  - "for"
  - "entprjmarginitem"
...
tags:
  ...
  - lob:finance
---
# I_ENTPRJMARGINITEMDST

**Document for EntPrjMarginItem**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENTPRJMARGINITEMDST')/$value) |
...
| `tra_ordertype` |  | |  |  | `CHAR(4)` |  |
| `sva_ordertype` |  | |  |  | `CHAR(1)` |  |
| `tra_wbselement` |  | |  |  | `CHAR(24)` |  |
| `sva_wbselement` |  | |  |  | `CHAR(1)` |  |
| `tra_projectuuid` |  | |  |  | `CHAR(32)` |  |
| `sva_projectuuid` |  | |  |  | `CHAR(1)` |  |
| `tra_00009` |  | |  |  | `NUMC(7)` |  |
| `sva_00009` |  | |  |  | `CHAR(1)` |  |
| `svh_00009` |  | |  |  | `CHAR(1)` |  |
| `hnm_00009` |  | |  |  | `CHAR(30)` |  |
...
| `tra_00015` |  | |  |  | `CHAR(2)` |  |
| `sva_00015` |  | |  |  | `CHAR(1)` |  |
| `tra_ordercategory` |  | |  |  | `NUMC(2)` |  |
| `sva_ordercategory` |  | |  |  | `CHAR(1)` |  |
| `tra_00016` |  | |  |  | `NUMC(23)` |  |
| `sva_00016` |  | |  |  | `CHAR(1)` |  |
| `tra_00017` |  | |  |  | `CHAR(32)` |  |
| `sva_00017` |  | |  |  | `CHAR(1)` |  |
...
| `TRA_00032` |  | |  | `cast( tra_00032 as fis_fp_entry_item_new )` | `INT4(10)` | Financial Planning Entry Item |
| `sva_00032` |  | |  |  | `CHAR(1)` |  |
| `tra_00033` |  | |  |  | `CHAR(10)` |  |
| `sva_00033` |  | |  |  | `CHAR(1)` |  |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENTPRJMARGINITEMDST')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENTPRJMARGINITEMDST')/$value)*

```abap
@AccessControl.authorizationCheck: #PRIVILEGED_ONLY
@EndUserText.label: 'Document for EntPrjMarginItem'
@VDM.viewType: #BASIC
...
@Analytics.document.storageForEntity: [ 'I_ENTPRJMARGINITEMCUBE' ]
@Analytics.document.serviceClassName: 'CL_CELL_COMMENT_GENERIC_HDLR'
@ObjectModel.usageType.sizeCategory: #XXL
@ObjectModel.usageType.serviceQuality: #D
@ObjectModel.usageType.dataClass: #MIXED
@Metadata.ignorePropagatedAnnotations:true
define view entity I_EntPrjMarginItemDSt
  as select from ientprjmadsttab
{
      @Analytics.document: {
        type: #DOC,
        semantics: #ID
  ...
  key version,
      ...
      @Analytics.document: {
        type: #TRA,
        reference: 'ControllingDebitCreditCode'
      }
      tra_00021,
      @Analytics.document: {
        type: #SVA,
      ...
      cast( tra_00032 as fis_fp_entry_item_new ) as TRA_00032,
      @Analytics.document: {
        type: #SVA,
        reference: 'FinancialPlanningEntryItem'
      }
