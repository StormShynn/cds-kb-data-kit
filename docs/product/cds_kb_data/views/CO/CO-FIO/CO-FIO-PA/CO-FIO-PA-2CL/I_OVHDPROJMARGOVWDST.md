...
semantic_vi: "Document for OverhdProjMargOvw — CDS view giao diện dựa trên iovhdprojdsttab."
keywords:
  - "document"
  - "for"
  - "overhdprojmargovw"
...
tags:
  ...
  - lob:finance
---
# I_OVHDPROJMARGOVWDST

**Document for OverhdProjMargOvw**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_OVHDPROJMARGOVWDST')/$value) |
...
| `tra_00011` |  | |  |  | `CHAR(4)` |  |
| `sva_00011` |  | |  |  | `CHAR(1)` |  |
| `TRA_00012` |  | |  | `cast( tra_00012 as fis_fp_entry_item_new )` | `INT4(10)` | Financial Planning Entry Item |
| `sva_00012` |  | |  |  | `CHAR(1)` |  |
| `tra_00013` |  | |  |  | `CHAR(4)` |  |
| `sva_00013` |  | |  |  | `CHAR(1)` |  |
| `tra_00014` |  | |  |  | `CHAR(2)` |  |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_OVHDPROJMARGOVWDST')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_OVHDPROJMARGOVWDST')/$value)*

```abap
@AccessControl.authorizationCheck: #PRIVILEGED_ONLY
@EndUserText.label: 'Document for OverhdProjMargOvw'
@VDM.viewType: #BASIC
...
@Analytics.document.storageForEntity: [ 'I_OVHDPROJMARGOVWCUBE' ]
@Analytics.document.serviceClassName: 'CL_CELL_COMMENT_GENERIC_HDLR'
@ObjectModel.usageType.sizeCategory: #XXL
@ObjectModel.usageType.serviceQuality: #D
@ObjectModel.usageType.dataClass: #MIXED
@Metadata.ignorePropagatedAnnotations:true
define view entity I_OvhdProjMargOvwDSt
  as select from iovhdprojdsttab
{
  @Analytics.document: {
    type: #DOC, 
    semantics: #ID
  ...
  cast( tra_00012 as fis_fp_entry_item_new ) as TRA_00012,
  @Analytics.document: {
    type: #SVA, 
    reference: 'FinancialPlanningEntryItem'
  }
  ...
  @Analytics.document: {
    type: #TRA, 
    reference: 'AvailabilityControlIsActive'
  }
  tra_00021,
  @Analytics.document: {
    type: #SVA, 
