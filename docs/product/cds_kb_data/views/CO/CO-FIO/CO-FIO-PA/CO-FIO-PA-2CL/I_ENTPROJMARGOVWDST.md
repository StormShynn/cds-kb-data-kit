...
semantic_vi: "Document for EntProjMargOvw — CDS view giao diện dựa trên ientprojmdsttab."
keywords:
  - "document"
  - "for"
  - "entprojmargovw"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENTPROJMARGOVWDST')/$value) |
...
| `TRA_00045` |  | |  | `cast( tra_00045 as fis_fp_entry_item_new )` | `INT4(10)` | Financial Planning Entry Item |
| `sva_00045` |  | |  |  | `CHAR(1)` |  |
| `tra_00046` |  | |  |  | `CHAR(10)` |  |
| `sva_00046` |  | |  |  | `CHAR(1)` |  |
| `tra_00047` |  | |  |  | `NUMC(8)` |  |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENTPROJMARGOVWDST')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_ENTPROJMARGOVWDST')/$value)*

```abap
@AccessControl.authorizationCheck: #PRIVILEGED_ONLY
@EndUserText.label: 'Document for EntProjMargOvw'
@VDM.viewType: #BASIC
...
@Analytics.document.storageForEntity: [ 'I_ENTPROJMARGOVWCUBE' ]
@Analytics.document.serviceClassName: 'CL_CELL_COMMENT_GENERIC_HDLR'
@ObjectModel.usageType.sizeCategory: #XXL
@ObjectModel.usageType.serviceQuality: #D
@ObjectModel.usageType.dataClass: #MIXED
@Metadata.ignorePropagatedAnnotations:true
define view entity I_EntProjMargOvwDSt
  as select from ientprojmdsttab
{
  @Analytics.document: {
    type: #DOC, 
    semantics: #ID
  ...
  cast( tra_00045 as fis_fp_entry_item_new ) as TRA_00045,
  @Analytics.document: {
    type: #SVA, 
    reference: 'FinancialPlanningEntryItem'
  }
