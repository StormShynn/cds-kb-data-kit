---
name: C_INVMTPROJBDGTCMTMTQUERY
...
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_INVMTPROJBDGTCMTMTQUERY')/$value
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_INVMTPROJBDGTCMTMTQUERY')/$value) |
