...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_HISTFINANCIALSTATUSQRY_2')/$value) |
...
| `FinancialPositionKeyDate` |  | |  |  | `DATS(8)` | Financial Position Key Date |
