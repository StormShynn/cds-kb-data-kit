---
name: C_HISTFINANCIALSTATUSQRY_2
description: "This CDS view provides you with information about the financial statuses at specific dates in the past by providing in display currency the amounts (book value or nominal amount) of financial positions at these dates contributing to the financial status. In addition, you can report the development of the financial positions of the data source Facilities for which the credit line amounts, the utilized amounts, and the available amounts are available in display currency. To help you decide which CDS view to use for your purposes, SAP has introduced the annotation ObjectModel.supportedCapabilities that indicates the most appropriate use cases for each CDS view. To find out what use cases are best supported by this CDS view, access the entry of the CDS view in the View Browser app and find the values for this annotation under the Annotation tab. For more information, see Supported Capabilities for CDS Views."
app_component: FIN-FSCM-TRM-2CL
software_component: SAPSCORE
release_state: released
system_type: S/4HANA Cloud Public Edition
source_available: true
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_HISTFINANCIALSTATUSQRY_2')/$value
semantic_en: "This CDS view provides you with information about the financial statuses at specific dates in the past by providing in display currency the amounts (book value or nominal amount) of financial positions at these dates contributing to the financial status. In addition, you can report the development of the financial positions of the data source Facilities for which the credit line amounts, the utilized amounts, and the available amounts are available in display currency. To help you decide which CDS view to use for your purposes, SAP has introduced the annotation ObjectModel.supportedCapabilities that indicates the most appropriate use cases for each CDS view. To find out what use cases are best supported by this CDS view, access the entry of the CDS view in the View Browser app and find the values for this annotation under the Annotation tab. For more information, see Supported Capabilities for CDS Views."
semantic_vi: "Financial Status History 2 — CDS view tiêu dùng dựa trên I_HistFinancialStatusCube."
keywords:
  - "financial"
  - "status"
  - "history"
...
tags:
  ...
  - lob:finance
---
# C_HISTFINANCIALSTATUSQRY_2

**This CDS view provides you with information about the financial statuses at specific dates in the past by providing in display currency the amounts (book value or nominal amount) of financial positions at these dates contributing to the financial status. In addition, you can report the development of the financial positions of the data source Facilities for which the credit line amounts, the utilized amounts, and the available amounts are available in display currency. To help you decide which CDS view to use for your purposes, SAP has introduced the annotation ObjectModel.supportedCapabilities that indicates the most appropriate use cases for each CDS view. To find out what use cases are best supported by this CDS view, access the entry of the CDS view in the View Browser app and find the values for this annotation under the Annotation tab. For more information, see Supported Capabilities for CDS Views.**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_HISTFINANCIALSTATUSQRY_2')/$value) |
...
| `FinancialPositionKeyDate` | ✓ | |  | `KeyDate` | `DATS(8)` | Financial Position Key Date |
...
| `BookValueAmountInDC` |  | |  | `cast( currency_conversion( amount => BookValueAmtInPositionCurrency, source_currency => TransactionCurrency, target_currency => :P_DisplayCurrency, exchange_rate_date => KeyDate, exchange_rate_type => :P_ExchangeRateType ) as ftr_fs_book_val_dc preserving type )` | `CURR(23)` | Book Value in Display Currency |
| `NominalAmountInDisplayCurrency` |  | |  | `cast( currency_conversion( amount => NominalAmountInNominalCurrency, source_currency => NominalCurrency, target_currency => :P_DisplayCurrency, exchange_rate_date => KeyDate, exchange_rate_type => :P_ExchangeRateType ) as ftr_fs_nominal_amount_dc preserving type )` | `CURR(23)` | Nominal Amount in Display Currency |
| `TotalAmountInDisplayCrcy` |  | |  | `cast( currency_conversion( amount => TotalAmountInTransactionCrcy, source_currency => TransactionCurrency, target_currency => :P_DisplayCurrency, exchange_rate_date => KeyDate, exchange_rate_type => :P_ExchangeRateType ) as ftr_totamtinrepcrcy preserving type )` | `CURR(17)` | Credit Line in Display Currency |
| `UtilizedAmountInDisplayCrcy` |  | |  | `cast( currency_conversion( amount => UtilizedAmountInTransCrcy, source_currency => TransactionCurrency, target_currency => :P_DisplayCurrency, exchange_rate_date => KeyDate, exchange_rate_type => :P_ExchangeRateType ) as ftr_utilamtinrepcrcy preserving type )` | `CURR(17)` | Utilized Amount in Display Currency |
| `FreeCreditLineAmtInDspCrcy` |  | |  | `cast(0 as ftr_availamtinrepcrcy)` | `CURR(17)` | Available Amount in Display Currency |

## Source Code

*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_HISTFINANCIALSTATUSQRY_2')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_HISTFINANCIALSTATUSQRY_2')/$value)*
...
@AbapCatalog.sqlViewName: 'CFINPQXPLF'
@AbapCatalog.compiler.compareFilter: true
@AccessControl.authorizationCheck: #PRIVILEGED_ONLY
@VDM.viewType: #CONSUMPTION
@OData.publish: true
@Analytics.query: true
@EndUserText.label: 'Financial Status History 2'
@Metadata.ignorePropagatedAnnotations: true
@Analytics.internalName: #LOCAL 
// ABAP exit implementation
define view C_HistFinancialStatusQry_2
  with parameters
    ...
    @Consumption.defaultValue: '4Q'    
    P_TreasuryPositionPeriod      : ftr_pos_hist_period

  as select from I_HistFinancialStatusCube( P_KeyDate: :P_KeyDate, P_TreasuryPositionPeriod: :P_TreasuryPositionPeriod)
{  
  //Row dimensions
  ...
  KeyDate as FinancialPositionKeyDate,
