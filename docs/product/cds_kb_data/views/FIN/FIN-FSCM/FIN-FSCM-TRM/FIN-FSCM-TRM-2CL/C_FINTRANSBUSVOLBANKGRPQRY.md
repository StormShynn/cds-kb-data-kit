...
semantic_vi: "Fin. Trans. Amount by Bank Group - Query — CDS view tiêu dùng dựa trên I_FinTransAmtCube."
keywords:
  - "fin."
  - "trans."
  - "amount"
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_FINTRANSBUSVOLBANKGRPQRY')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_FINTRANSBUSVOLBANKGRPQRY')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_FINTRANSBUSVOLBANKGRPQRY')/$value)*

```abap
@AbapCatalog.sqlViewName: 'CTRANSBUSVOLQRY'
...
@EndUserText.label: 'Fin. Trans. Amount by Bank Group - Query'
@OData.publish: true
define view C_FinTransBusVolBankGrpQry 
  with parameters
  ...
  key Counterparty,
      ...
      @AnalyticsDetails: {
        exceptionAggregationSteps: [{ exceptionAggregationBehavior : #FIRST,
                                      exceptionAggregationElements: ['Keydate']
                                   }],
