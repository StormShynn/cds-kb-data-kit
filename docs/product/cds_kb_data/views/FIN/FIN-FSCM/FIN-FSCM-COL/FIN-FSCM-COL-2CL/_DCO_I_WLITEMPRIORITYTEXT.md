...
tags:
  ...
  - metadata-only
---
# _DCO_I_WLITEMPRIORITYTEXT

**Priority of Worklist Item - Text**
...
| Source | [View Hub catalog entry](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('_DCO_I_WLITEMPRIORITYTEXT')/$value) |
...
| `DCoWorklistItemPriorityName` |  | |  |  | `CHAR(50)` | Priority Name |
