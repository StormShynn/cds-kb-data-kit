...
semantic_vi: "Income Statement - Function of Expense — CDS view tiêu dùng dựa trên Income Statement - Function of Expense."
keywords:
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CNSLDTNINCSTMNTFUNCOFEXPNQ')/$value) |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CNSLDTNINCSTMNTFUNCOFEXPNQ')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('C_CNSLDTNINCSTMNTFUNCOFEXPNQ')/$value)*

```abap
@AccessControl.authorizationCheck: #NOT_ALLOWED
@Analytics: {
    technicalName: 'CCNSLDTISFOE',
...
@EndUserText.label: 'Income Statement - Function of Expense'

define transient view entity C_CnsldtnIncStmntFuncOfExpnQ
