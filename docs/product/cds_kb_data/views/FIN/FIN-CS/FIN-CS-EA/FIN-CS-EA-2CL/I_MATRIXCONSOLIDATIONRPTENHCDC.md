---
name: I_MATRIXCONSOLIDATIONRPTENHCDC
description: "This CDS view provides access to the consolidated data for both statutory and management consolidation reporting. You can create group reports for consolidation groups, such as cash flow statements based on organizational units such as profit centers, segments, and companies, with the data provided by this CDS view. Compared with Group Data Analysis Cube, it supports the rule-based reports where your defined reporting items are displayed as reporting dimensions. For more information, see Rule-Based Reports. This CDS view provides the prerequisites for answering the following business questions: What is the consolidation dimension, consolidation chart of accounts, and consolidation ledger in which the reporting logic is applied? What is the organizational unit information of the consolidated data in my specified fiscal year and period? What is the document number, posting level, and document type for a certain journal entry? What are the amounts of relevant financial statement items or reporting items in the transaction currency, local currency, and group currency? What are the interunit elimination-related amounts, for example, for eliminations between profit centers, segments, and companies?"
app_component: FIN-CS-EA-2CL
software_component: SAPSCORE
release_state: released
system_type: S/4HANA Cloud Public Edition
source_available: true
source_url: https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MATRIXCONSOLIDATIONRPTENHCDC')/$value
semantic_en: "This CDS view provides access to the consolidated data for both statutory and management consolidation reporting. You can create group reports for consolidation groups, such as cash flow statements based on organizational units such as profit centers, segments, and companies, with the data provided by this CDS view. Compared with Group Data Analysis Cube, it supports the rule-based reports where your defined reporting items are displayed as reporting dimensions. For more information, see Rule-Based Reports. This CDS view provides the prerequisites for answering the following business questions: What is the consolidation dimension, consolidation chart of accounts, and consolidation ledger in which the reporting logic is applied? What is the organizational unit information of the consolidated data in my specified fiscal year and period? What is the document number, posting level, and document type for a certain journal entry? What are the amounts of relevant financial statement items or reporting items in the transaction currency, local currency, and group currency? What are the interunit elimination-related amounts, for example, for eliminations between profit centers, segments, and companies?"
semantic_vi: "Rule-Based Group Data Analysis - Cube — CDS view giao diện dựa trên P_CNSLDTNFNDNWITHRPTRULES_2."
keywords:
...
**This CDS view provides access to the consolidated data for both statutory and management consolidation reporting. You can create group reports for consolidation groups, such as cash flow statements based on organizational units such as profit centers, segments, and companies, with the data provided by this CDS view. Compared with Group Data Analysis Cube, it supports the rule-based reports where your defined reporting items are displayed as reporting dimensions. For more information, see Rule-Based Reports. This CDS view provides the prerequisites for answering the following business questions: What is the consolidation dimension, consolidation chart of accounts, and consolidation ledger in which the reporting logic is applied? What is the organizational unit information of the consolidated data in my specified fiscal year and period? What is the document number, posting level, and document type for a certain journal entry? What are the amounts of relevant financial statement items or reporting items in the transaction currency, local currency, and group currency? What are the interunit elimination-related amounts, for example, for eliminations between profit centers, segments, and companies?**
...
| Source | [View source file](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MATRIXCONSOLIDATIONRPTENHCDC')/$value) |
...
| `AmountInTransactionCurrency` |  | |  | `cast ( case when ConsolidationReverseSign = 'X' then -1 * AmountInTransactionCurrency else AmountInTransactionCurrency end as fincs_tsl )` | `CURR(23)` | Amount in Transaction Currency |
| `AmountInLocalCurrency` |  | |  | `cast( case when ConsolidationReverseSign = 'X' then -1 * AmountInLocalCurrency else AmountInLocalCurrency end as fincs_hsl )` | `CURR(23)` | Amount in Local Currency |
| `AmountInGroupCurrency` |  | |  | `cast( case when ConsolidationReverseSign = 'X' then -1 * AmountInGroupCurrency else AmountInGroupCurrency end as fincs_ksl )` | `CURR(23)` | Amount in Group Currency |
| `QuantityInBaseUnit` |  | |  | `case when ConsolidationReverseSign = 'X' then -1 * QuantityInBaseUnit else QuantityInBaseUnit end` | `QUAN(28)` |  |
| `CnsldtnQuantityInBaseUnit` |  | |  | `case when ConsolidationReverseSign = 'X' then -1 * CnsldtnQuantityInBaseUnit else CnsldtnQuantityInBaseUnit end` | `QUAN(31)` |  |
...
*Source: [https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MATRIXCONSOLIDATIONRPTENHCDC')/$value](https://api.sap.com/odata/1.0/catalog.svc/CdsViewsContent.CdsViews('I_MATRIXCONSOLIDATIONRPTENHCDC')/$value)*

```abap
@AbapCatalog.sqlViewName: 'IMCRPTENHANC'
@AbapCatalog.compiler.compareFilter: true
@AccessControl.authorizationCheck: #CHECK
@VDM.viewType: #COMPOSITE
@VDM.lifecycle.contract.type:#PUBLIC_LOCAL_API 
@VDM.lifecycle.status: #DEPRECATED
@VDM.lifecycle.successor: 'I_MATRIXCNSLDTNREPORTENHCDC_2'
...
@Analytics.readClassName: 'CL_FINCS_GRA_CUBE_RR_REL'
@EndUserText.label: 'Rule-Based Group Data Analysis - Cube'

define view I_MatrixConsolidationRptEnhcdC
  with parameters
...

{
  ...
  key ConsolidationPostingItem,
      ...
      cast ( case
             ...
             end as fincs_tsl )                            as AmountInTransactionCurrency,
      ...
      cast( case
            ...
            end as fincs_hsl )                             as AmountInLocalCurrency,
      ...
      cast( case
            ...
            end as fincs_ksl )                             as AmountInGroupCurrency,
      ...
      case
          when ConsolidationReverseSign = 'X' then  -1 * QuantityInBaseUnit
      ...
      end                                               as CnsldtnQuantityInBaseUnit,
