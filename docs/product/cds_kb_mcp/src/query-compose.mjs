// query-compose.mjs — DOM-free OpenSQL + CDS view skeleton from the same
// JSON shape Query Builder's currentQueryAsObject() / share links use.
// Ported from docs/product/cds_kb_data/scripts/generate-query-builder.mjs
// (embedded browser builders). Keep the input contract in sync with that page;
// do not import the HTML generator.
...
/**
 * Build FROM / JOIN lines. Association-mode rows contribute no FROM line
 * (path expression in the element list instead).
